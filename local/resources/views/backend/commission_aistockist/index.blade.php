...
@section('content')
    ...
    <form id="action_form" action="{{ url('backend/commission_aistockist_pdf') }}" method="POST" target="_blank"
...
@section('script')
    ...
    <script>
        ...
        function modal_commission_transfer(customer_id, date_transfer) {
            ...
            //alert(date_transfer);
            $.ajax({
                    url: '{{ url('backend/commission_transfer_aistockist/modal_commission_transfer_aistockist') }}',
                    type: 'GET',
                    data: {
