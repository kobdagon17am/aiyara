...
.cut-imgnews img {
    ...
    color: #000000;
    z-index: 1;
    text-shadow: 1.5px 1.5px 1px #3333335e;
    text-transform: uppercase;
...
.img-bg-contact img {
    ...
    color: #000000;
    z-index: 1;
    text-shadow: 1.5px 1.5px 1px #3332;
}
    .nopad {
        padding: 0;
    }
...
<body style="background-color: #f7f7f7;">
    ...
    <div class="container-fluid nopan wow fadeInDown">
       <div class="col-12 nopad img-bg-contact">
                <h2>ข่าวสาร</h2>
                <img src="../webpromote/images/bg-news.jpg" class="img-fluid" style="width: 100%;">
            </div>
    </div>
            ...
            <div class="row">
                <div class="col-sm-9 ">
                    ...
                    <div class="box-homenew">
                        <a href="detail">
                        <div class="cut-imgnews">
                         <img src="../webpromote/images/1-new.jpg" class="img-fluid">
                         </div>
                         </a>
                        <div class="text-box-homenew">
                            <a href="new_readmore.php">
                                <h6>เนื้อหาจำลอง</h6>
                                <p>ที่ใช้กันในธุรกิจงานพิมพ์หรืองานเรียงพิมพ์ มันได้กลายมาเป็นเนื้อหาจำลองมาตรฐานของธุรกิจดังกล่าวมาตั้งแต่ศตวรรษที่</p>
                            </a>
                            <a href="detail" class="boxnews">อ่านต่อ <i class="fa fa-angle-right" aria-hidden="true"></i></a>
                        </div>
                    </div>
                </div>
                 ...
                 <div class="col-12 col-md-4 col-lg-4">
                    <div class="box-homenew">
                        <a href="detail">
                        <div class="cut-imgnews">
                         <img src="../webpromote/images/2-new.jpg" class="img-fluid">
                         </div>
                         </a>
                        <div class="text-box-homenew">
                            <a href="detail">
                ...
                <div class="col-12 col-md-4 col-lg-4">
                    <div class="box-homenew">
                        <a href="detail">
                        <div class="cut-imgnews">
                         <img src="../webpromote/images/4-new.jpg" class="img-fluid">
                         </div>
                         </a>
                        <div class="text-box-homenew">
                            <a href="detail">
