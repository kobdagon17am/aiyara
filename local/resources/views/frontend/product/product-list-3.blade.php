        ...
        <div class="prod-item text-center">
            <div class="prod-img">
                <div class="option-hover">
                   ...
                   <a href="{{route('product-detail-3',['id'=>$value->id])}}" type="button" 
                    ...
                    <a href="{{route('product-detail-3',['id'=>$value->id])}}"
...
<div class="prod-info">
    <a href="{{route('product-detail-3',['id'=>$value->id])}}" class="txt-muted">
