                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group row"> &nbsp; &nbsp;
                                            <button type="button" class="btn btn-success btn-sm waves-effect btnSearch "
                                                ...
                                                <i class="bx bx-search font-size-16 align-middle mr-1"
                                                    style="cursor: pointer;"></i> ค้น
                                            </button>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        ...
        $(function() {
            oTable0001 = $('#data-table-0001').DataTable({
                ...
                columns: [{
                        data: 'column_001',
                        title: '<span style="vertical-align: middle;"> ผู้ส่ง </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'column_002',
                        title: '<span style="vertical-align: middle;"> ครั้งที่ส่ง </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'column_003',
                        title: '<span style="vertical-align: middle;"> รายการใบเสร็จ (คลิกเพื่อดูบิลเพิ่มเติม) </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'date_order',
                        title: '<span style="vertical-align: middle;"> วันที่รายการ </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'column_004',
                        title: '<span style="vertical-align: middle;"> วันเวลาที่ส่ง </span> ',
                        className: 'text-center'
                    },
                    // {data: 'column_005', title :'<span style="vertical-align: middle;">รวมรายการชำระค่าสินค้า </span> ', className: 'text-center'},
                    {
                        data: 'column_005',
                        title: '<span style="vertical-align: middle;">รวมเงินสด </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'column_007',
                        title: '<span style="vertical-align: middle;">สถานะ </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'approver',
                        title: '<span style="vertical-align: middle;">ผู้รับเงิน </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'approver_time',
                        title: '<span style="vertical-align: middle;">เวลารับเงิน </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'detail',
                        title: '<span style="vertical-align: middle;">หมายเหตุ </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'column_006',
                        ...
                        render: function(d) {
                            var show = '<a style="' + d +
                                ...
                                d + '" > ยกเลิก </a>';
                            return '<a style="' + d +
                                '" href="{{ route('backend.check_money_daily.index') }}/' + d +
            ...
            oTable0002 = $('#data-table-0002').DataTable({
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        title: '<span style="vertical-align: middle;"> Business Location </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'branch_name',
                        title: '<span style="vertical-align: middle;"> Branch </span> ',
                        className: 'text-center'
                    },
                    {
                        data: 'action_user',
                        title: '<span style="vertical-align: middle;"> พนักงานขาย </span> ',
                        className: 'text-center'
                    },
                    {
                    ...
                    },
                    {
                        ...
                        title: '<span style="vertical-align: middle;"> ยอดส่งเงิน (เฉพาะเงินสด)</span> ',
                        className: 'text-right'
                    },
                    {
                        data: 'total_money_sent',
                        title: '<span style="vertical-align: middle;"> ยอดรับเงิน (เฉพาะเงินสด)</span> ',
                        className: 'text-right'
                    },
            ...
            oTable0002 = $('#data-table-0002_2').DataTable({
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['remark'] == 2) {
                        ...
                        if (aData['total_money']) {
                            $('td:eq(3)', nRow).html(
                                '<span class="text-right" style="color:black;font-size:16px;font-weight:bold;"> รวมทั้งสิ้น </span>'
                            );
                            $('td:eq(4)', nRow).html(
                                '<span class="text-right" style="color:black;font-size:16px;font-weight:bold;">' +
                                aData['total_money'] + '</span>');
                        }
                    }
            ...
            oTable = $('#data-table-002').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        title: '<center>พนักงานขาย </center>',
                        className: 'text-left'
                    },
                    {
                        data: 'cash_pay',
                    ...
                    {
                        data: 'total_price',
                        title: '<center>รวมทั้งสิ้น </center>',
                        className: 'text-center'
                    },
                    {
                        data: 'approve_status',
                        ...
                        render: function(d) {
                            if (d == "รออนุมัติ") {
                                return '<span class="badge badge-pill badge-soft-warning font-size-16" style="color:darkred">' +
                                    d + '</span>';
                            } else if (d == "ไม่อนุมัติ") {
                                return '<span class="badge badge-pill badge-soft-danger font-size-16" style="color:red">' +
                                    d + '</span>';
                            } else {
                                return '<span class="badge badge-pill badge-soft-primary font-size-16" style="color:darkred">' +
                                    d + '</span>';
                            }
                        }
                    },
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (sU != '' && sD != '') {
                        ...
                        $('td:last-child', nRow).html('' +
                            '<a href="{{ route('backend.check_money_daily.index') }}/' + aData[
                                'id'] +
                            '/edit?fromFrontstore" class="btn btn-sm btn-primary" style="' + sU +
                            '" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
