                            ...
                            <div class="tab-content tabs card-block">
                                        ...
                                        <ul class="feed-blog">
                                            ...
                                            @foreach ($data as $value)
                                                ...
                                                @if ($value->id <= $qualification_id)
                                                    <?php $rs_check =
                                                    \App\Helpers\Frontend::check_reward_history($customer_id, $value->id);
                                                    ?>
                                                    <li class="active-feed" style="margin-bottom: 25px;">
                                                        <div class="feed-user-img">
                                                            <img src="{{ asset('frontend/assets/images/true.png') }}"
                                                                class="img-radius " alt="User-Profile-Image">
                                                        </div>
                                                        <h6><span class="label label-success">Active</span>
                                                            {{ $value->business_qualifications }}</h6>
                                                        @if ($rs_check)
                                                            <p><small class="text-muted">Date
                                                                    {{ date('d/m/Y', strtotime($rs_check->created_at)) }}</small>
                                                            </p>
                                                        @endif
                                                    </li>
                                                @else
                                                    <li class="diactive-feed" style="margin-bottom: 30px;">
                                                        <div class="feed-user-img">
                                                            <img src="{{ asset('frontend/assets/images/false.png') }}"
                                                                class="img-radius " alt="User-Profile-Image">
                                                        </div>
                                                        <h6><span class="label label-inverse-info-border">Not Active</span>
                                                            {{ $value->business_qualifications }}</h6>
                                                    </li>
                                ...
                                <div class="tab-pane" id="profile1" role="tabpanel" aria-expanded="false">
                                    <div class="card-block list-tag">
                                        <ul class="feed-blog">
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Crown-Diamond-.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <p style="margin-bottom: 10px;">แนะนำตรง BLACK DIAMOND STAR (active
                                                            ในเดือนเดียวกัน) L/T 5 รหัส : M/T 5 รหัส</p>
                                                    </li>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Triple-Diamond.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Black Diamond star (active
                                                            ในเดือนเดียวกัน) : L/T 3 รหัส : M/T 3 รหัส</p>
                                                    </li>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/DOUBLE-Diamond.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Black Diamond star (active
                                                            ในเดือนเดียวกัน) L/T 1 รหัส : M/T 1 รหัส</p>
                                                    </li>
                                  ...
                                  <h6>Black Diamond Star (BDS)</h6>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/EDS.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Platinum Star (active) L/T
                                                            4 รหัส : M/T 4 รหัส และรับโบนัส FS+TMB = 1,500,000 บาท/เดือน
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Diamond.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Emerald.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Platinum star (active) :
                                                            L/T 2 รหัส : M/T 2 รหัส มีคะแนน M/T = 1,000,000 PV/เดือน
                                                            และรับโบนัส FS+TMB = 450,000 บาท/เดือน (จำนวน 2 เดือน ติดต่อกัน)
                                                        </p>
                                                    </li>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> รักษาคุณสมบัติ
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Blue-.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                <h6>Blue Star (BLS)</h6>
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Platinum Star (active) L/T
                                                            1 รหัส : M/T 1 รหัส มีคะแนน M/T = 800,000 PV/เดือน<br>
                                                            และโบนัส FS + TMB = 250,000 บาท/เดือน (จำนวน 2 เดือน ติดต่อกัน)
                                                        </p>
                                                    </li>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> รักษาคุณสมบัติ
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Supphire-e.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/ruby.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                <h6>Ruby Star (RUS)</h6>
                                                <ul>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/BLACK-PEARL.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/PEARL.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                <h6>Perl Star (PES)</h6>
                                                <ul>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/PS.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                  ...
                                  <h6>Double Gold Star (DGS)</h6>
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Gold.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Basic : L/T 5 รหัส : M/T 5
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/Silver.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Basic : L/T 3 รหัส : M/T 3
                                            ...
                                            <li class="diactive-feed" style="margin-bottom: 10px;">
                                                <div class="feed-user-img">
                                                    <img src="{{ asset('frontend/assets/images/img_reward/BronzeStarAward.png') }}"
                                                        class="img-radius " alt="User-Profile-Image">
                                                </div>
                                                ...
                                                <ul>
                                                    <li>
                                                        <i class="icofont icofont-hand-right text-info"></i> ทำคุณสมบัติ (Q)
                                                        <p style="margin-bottom: 10px;">แนะนำตรง Basic : L/T 1 รหัส : M/T 1
