...
<div class="myBorder" >
        ...
        <div style="">
          ...
          <div class="form-group row">
            <div class="col-md-12">
              <table id="data-table-history" class="table table-bordered " style="width: 100%;">
              </table>
            </div>
          </div>
        </div>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-body">
                    ...
                    <div class="col-md-6 " >
                        <div class="form-group row">
                            <label for="" class="col-md-3 col-form-label"> จำนวนที่ได้รับ : </label>
                            <div class="col-md-3">
                             <input type="text" class="form-control NumberOnly " name="amt_get" id="amt_get" required >
                            </div>

                            <label for="" class="col-md-2 col-form-label">หน่วย : * </label>
       ...
       <div class="row" >
                ...
                <div class="row" >
                  ...
                  <div class="row" >
                    ...
                    <div class="col-md-5 " >
                        <div class="form-group row">
                            <label for="shelf_id_fk_c" class="col-md-3 col-form-label"> Shelf : </label>
                            <div class="col-md-5">
