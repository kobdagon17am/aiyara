        ...
        <div class="prod-item text-center">
            <div class="prod-img">
                <div class="option-hover">
                   ...
                   <a href="{{route('product-detail-3',['id'=>$value->products_id])}}" type="button" 
                    ...
                    <a href="{{route('product-detail-3',['id'=>$value->products_id])}}"
...
<div class="prod-info">
    <a href="{{route('product-detail-3',['id'=>$value->products_id])}}" class="txt-muted">
