...
class Products_borrow_chooseController extends Controller
{
   ...
   public function form($id=NULL)
    ...
    {
      $sRow = \App\Models\Backend\Products_borrow_choose::find($id);
      if( $sRow ){
        $sRow->forceDelete();
      }
    ...
    public function Datatable(){
      ...
      $sTable = \App\Models\Backend\Products_borrow_choose::where('action_user',\Auth::user()->id)->search()->orderBy('id', 'asc');
