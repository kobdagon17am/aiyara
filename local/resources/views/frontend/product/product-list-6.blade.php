        ...
        <div class="prod-item text-center">
            <div class="prod-img">
                <div class="option-hover">
                   ...
                   <a href="{{route('product-detail-6',['id'=>$value->products_id])}}" type="button" 
                    ...
                    <a href="{{route('product-detail-6',['id'=>$value->products_id])}}"
...
<div class="prod-info">
    <a href="{{route('product-detail-6',['id'=>$value->products_id])}}" class="txt-muted">
...
<script type="text/javascript">
    function select_category(){
        ...
        $.ajax({
            ...
            type: 'GET',
            data: {'category_id':category,'type':6},
        })
        .done(function(data){
