            ...
            <div class="card-header">
                <div class="row">
                    ...
                    <div class="col-md-8 col-sx-8">
                        <h4>รายการคอร์สอบรม</h4>
                    </div>
                    <div class="col-md-4 col-sx-4 text-right">
                        <a href="{{route('product-list-6')}}" class="btn btn-primary bt-sm" type="">เลือกสินค้า</a>
                    </div>
                </div>
                        ...
                        <div class="dt-responsive table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr id="items">
                                        <td class="text-center"><a href="{{ route('product-detail-6',['id'=>$value['id']]) }}"><img src="{{asset($value['attributes']['img'])}}" class="img-fluid zoom img-70" alt="tbl"></a>
                                        </td>
                                        <td>
                                            <h6>{{ $value['name'] }}</h6>
...
<script type="text/javascript">
  ...
  function quantity_change(item_id){ 
    ...
    $.ajax({
        url: '{{ route('edit_item') }}',
        type: 'POST',
        data: {'_token':'{{ csrf_token() }}',item_id:item_id,'qty':qty,'type':6},
    })
    .done(function(data) {
