...
// ๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑๑
   ...
   $db_orders = DB::select("
    ...
    for ($i=0; $i < $amt_page ; $i++) { 
        ...
        $L = 1 ;
        for ($k=0; $k < $limit ; $k++) { 
              $product_list = DB::select(" SELECT * FROM temp_z01_print_frontstore_print_receipt_02_tmp where id=$L ");
        ...
        if($m==2){
                $L2 = $limit+1;
                for ($k=0; $k < $limit ; $k++) { 
                      $product_list = DB::select(" SELECT * FROM temp_z01_print_frontstore_print_receipt_02_tmp where id=$L2 ");
                       foreach ($product_list as $key => $value) {
                           DB::select(" UPDATE $TABLE SET 
                            a = $L2,
                            b = '$value->b',
        ...
        if($m==3){
                $L3 = ($limit*2)+1;
                for ($k=0; $k < $limit ; $k++) { 
                      $product_list = DB::select(" SELECT * FROM temp_z01_print_frontstore_print_receipt_02_tmp where id=$L3 ");
                       foreach ($product_list as $key => $value) {
                           DB::select(" UPDATE $TABLE SET 
                            a = $L3,
                            b = '$value->b',
        ...
        if($m==4){
                $L4 = ($limit*3)+1;
                for ($k=0; $k < $limit ; $k++) { 
                      $product_list = DB::select(" SELECT * FROM temp_z01_print_frontstore_print_receipt_02_tmp where id=$L4 ");
                       foreach ($product_list as $key => $value) {
                           DB::select(" UPDATE $TABLE SET 
                            a = $L4,
                            b = '$value->b',
        ...
        DB::select(" UPDATE $TABLE SET a = 'REF : [ $id ] AG : [ $branch_code ] SK : [ - ] คะแนนครั้งนี้ : [  pv ]' WHERE id = (($n*$i)+16) ; ");
        DB::select(" UPDATE $TABLE SET a = 'ชำระ : [ $pay_type ] พนักงาน : [ $action_user_name ] การจัดส่ง : [ 4/ ]' WHERE id = (($n*$i)+17) ; ");
