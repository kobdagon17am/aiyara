                    ...
                    <div class="myBorder">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <input class="form-control" type="text" name="tr_number"
                                        value="{{ @$sRow->tr_number }}" readonly>
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @else
                                    <select id="get_from_branch_id_fk" name="get_from_branch_id_fk"
                                        class="form-control select2-templating " disabled>
                                        @if (@$sBranchs)
                                            @foreach (@$sBranchs as $r)
                                                <option value="{{ $r->id }}"
                                                    {{ @$r->id == @$sRow->get_from_branch_id_fk ? 'selected' : '' }}>
                                                    {{ $r->b_name }}
                                                </option>
                                            @endforeach
                                        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                ...
                                @if (empty(@$sRow->action_user))
                                    ...
                                    <select name="action_user" id="action_user" class="form-control select2-templating "
                                        required>
                                    ...
                                    <select name="action_user" id="action_user" class="form-control select2-templating "
                                        ...
                                        @if (@$sUserAdmin_ALL)
                                            @foreach (@$sUserAdmin_ALL as $r)
                                                <option value="{{ $r->id }}"
                                                    {{ @$r->id == @$sRow->action_user ? 'selected' : '' }}>
                                                    {{ $r->name }}
                                                </option>
                                            @endforeach
                                        @endif
...
@else
    ...
    @endif
                        ...
                        <div class="form-group mb-0 row">
                            <div class="col-md-6">
                                <a class="btn btn-secondary btn-sm waves-effect"
                                    href="{{ url('backend/transfer_branch_get') }}">
                  ...
                  <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.transfer_branch_get_products.create') }}/{{ @$sRow->id }}" style="float: right;" >
                    ...
                    <div class="myBorder div_approve_transfer_branch_get ">
                        ...
                        <form id="frm-main" action="{{ route('backend.transfer_branch_get.update', @$sRow->id) }}"
                            method="POST" enctype="multipart/form-data" autocomplete="off">
                            <input name="_method" type="hidden" value="PUT">
    ...
    <div class="modal fade" id="setToWarehouseModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document" style="max-width: 800px !important;">
            <div class="modal-content">
                ...
                <form action="{{ route('backend.transfer_branch_get_products.store') }}" method="POST"
                    enctype="multipart/form-data" autocomplete="off">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12" style="font-size: 18px;">
                                                <div class="form-group row">
                                                    <label for="div_show_product" class="col-md-3 "
                                                        style="vertical-align: top;"> สินค้า : </label>
                                                    <div class="col-md-9">
                                                        <div id="div_show_product"
                                                            style="vertical-align: top;color: black;"></div>

                                                        <input type="hidden" class="form-control" id="lot_number"
    ...
    <div class="modal fade" id="product_repair" tabindex="-1" role="dialog" aria-labelledby="product_repairTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document" style="max-width: 800px !important;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="product_repairTitle"><b><i class="bx bx-play"></i>บันทึกสินค้าชำรุด
                        </b></h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                ...
                <form action="{{ url('backend/transfer_branch_get_products_defective') }}" method="POST"
                    enctype="multipart/form-data" autocomplete="off">
                    <input type="hidden" name="save_set_to_warehouse" value="1">
                                            ...
                                            <div class="col-md-12" style="font-size: 18px;">
                                                <div class="form-group row">
                                                    <label for="div_show_product" class="col-md-3 "
                                                        style="vertical-align: top;"> สินค้า : </label>
                                                    <div class="col-md-9">
                                                        <div id="div_show_product2"
                                                            style="vertical-align: top;color: black;"></div>

                                                        <input type="hidden" class="form-control" id="lot_number2"
                                                            name="lot_number" readonly>
                                                        <input type="hidden" class="form-control" id="lot_expired_date2"
                                                            name="lot_expired_date" readonly>
                                                        <input type="hidden" class="form-control"
                                                            id="product_unit_id_fk2" name="product_unit_id_fk" readonly>
                                                        <input type="hidden" class="form-control" id="branch_id_fk_c2"
                                                            name="branch_id_fk_c" readonly>
                                                        <!-- บอกสถานะว่า มีการปฏิเสธการรับ จากฝั่งรับ  -->
                                                        <!-- <input type="text"  id="tr_status_get" name="tr_status_get" readonly > -->
                        ...
                        if (aData['get_status_2'] == 2) {
                            ...
                            if (aData['tr_status'] > 2) {
                                ...
                                $('td:last-child', nRow).html('' +
                                    ...
                                    '" product_details="' + aData['product_details'] +
                                    '" branch_name="' + aData['branch_name'] +
                                    '" branch_id_this="' + aData['branch_id_this'] +
                                    '" lot_number="' + aData['lot_number'] +
                                    '" lot_expired_date="' + aData['lot_expired_date'] +
                                    '" product_unit_id_fk="' + aData['product_unit_id_fk'] +
                                    '"  ><i class="bx bx-plus font-size-16 align-middle"></i> เพิ่มการรับ </a> ' +
                                    '<a href="#" class="btn btn-sm btn-danger btnSetToWarehouse_repair " data-id="' +
                                    aData['id'] + '" product_name="' + aData['product_name'] +
                                    '" product_id_fk="' + aData['product_id_fk'] +
                                    '" product_details="' + aData['product_details'] +
                                    '" branch_name="' + aData['branch_name'] +
                                    ...
                                    '" lot_expired_date="' + aData['lot_expired_date'] +
                                    '" product_unit_id_fk="' + aData['product_unit_id_fk'] +
                                    '"  ><i class="bx bx-plus font-size-16 align-middle"></i> สินค้าชำรุด </a> '
                                ).addClass('input');
                            }
            ...
            oTable2 = $('#data-table-02').DataTable({
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['tr_status_get'] > 2) {
                        ...
                        $('td:last-child', nRow).html('' +
                            '<a href="javascript: void(0);" data-url="{{ route('backend.transfer_branch_get.index') }}/' +
                            aData['id'] +
