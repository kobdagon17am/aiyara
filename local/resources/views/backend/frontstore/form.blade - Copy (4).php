...
<!-- 6 = คอร์สอบรม -->
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label for="" class="col-md-4 col-form-label"> รูปแบบการชำระเงิน </label>
                    <div class="col-md-6">
                      <select id="pay_type6_id_fk" name="pay_type6_id_fk" class="form-control select2-templating " required="" >
                        <option value="">Select</option>
                        @if(@$sPay_type_purchase_type6)
                        @foreach(@$sPay_type_purchase_type6 AS $r)
                ...
                <div class="form-group row">
                  ...
                  <div class="col-md-5">
                      <div class="divTableCell">
                        <input class="form-control f-ainumber-18-b input-aireadonly in-tx " name="cash_pay" id="cash_pay" value="" readonly="" >
                      </div>
                      <div class="divTableCell">
 ...
 <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group row">
                  <label for="" class="col-md-4 col-form-label">  ระบุรหัสสมาชิก Ai-cash : </label>
                  <div class="col-md-5">
                      <div class="divTableCell">
                     <!-- ด้านซ้าย ว่างไว้ -->
                      </div>
                      <div class="divTableCell">
                                <select  id="member_id_aicash6" name="member_id_aicash" class="form-control select2-templating " required="" >
                                <option value="">Select</option>
                                  @if(@$Customer)
...
<?php
// echo @$sRow;
  if(!empty(@$sRow) && @$sRow->purchase_type_id_fk!=6){ // 6 = คอร์สอบรม
 ?>
<div class="row"  >
  <div class="col-12">
...
<script type="text/javascript">
         ...
         $(document).on('change', '#pay_type6_id_fk', function(event) {

                        event.preventDefault();
                        $(".myloading").show();

                        var purchase_type_id_fk = "{{@$sRow->purchase_type_id_fk}}";
                        var pay_type_id_fk = $("#pay_type6_id_fk").val();

                        console.log("ประเภทการซื้อ : " + purchase_type_id_fk);
                        console.log("รูปแบบการชำระเงิน : " + pay_type_id_fk);
