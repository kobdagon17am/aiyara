  ...
  <div class="col-12">
      <div class="card">
          <div class="card-body">
              ...
              <table id="data-table" class="table table-bordered dt-responsive thai_cambodia" style="width: 100%;">
              </table>
              ...
              <table id="data-table" class="table table-bordered dt-responsive total_thai_cambodia mt-0" style="width: 100%;">
              </table>
      ...
      oTable = $('.thai_cambodia').DataTable({
        "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
          ...
          columns: [
            ...
            {data: 'total_balance', title :'<center>จำนวนรวม</center>', className: 'text-right'},
            {data: 'total_price', title :'<center>จำนวนเงินสดรวม</center>', className: 'text-right'},
            {data: 'total_transfer', title :'<center>จำนวนเงินโอนรวม</center>', className: 'text-right'},
            {data: 'total_credit_card', title :'<center>จำนวนเงินเครดิตรวม</center>', className: 'text-right'},
            {data: 'total_aicash', title :'<center>Ai-Cash</center>', className: 'text-right'},
            {data: 'total_add_aicash', title :'<center>เติม Ai-Cash</center>', className: 'text-right table-warning'},
          ],
      });
    ...
    oTable_total = $('.total_thai_cambodia').DataTable({
        "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
          ...
          columns: [
              ...
              //     className: 'text-center'
              // },
            {data: 'total_balance', title :'<center>จำนวนรวม</center>', className: 'text-right text-success'},
            {data: 'total_price', title :'<center>จำนวนเงินสดรวม</center>', className: 'text-right text-success '},
            {data: 'total_transfer', title :'<center>จำนวนเงินโอนรวม</center>', className: 'text-right text-success'},
            {data: 'total_credit_card', title :'<center>จำนวนเงินเครดิตรวม</center>', className: 'text-right text-success'},
            {data: 'total_aicash', title :'<center>Ai-Cash</center>', className: 'text-right text-success'},
            {data: 'total_add_aicash', title :'<center>เติม Ai-Cash</center>', className: 'text-right table-warning'},
          ],
      });
      $('.myWhere,.myLike,.myCustom,#onlyTrashed').on('change', function(e) {
