...
class Po_receive_productsController extends Controller
{

    public function index(Request $request)
    {

      return view('backend.po_receive_products.index');
  ...
  public function create($id)
    {
       ...
       return View('backend.po_receive_products.form')->with(array(
        'sRowNew'=>$sRowNew,
        'sProduct'=>$sProduct,
    ...
    public function edit($id)
    {
       ...
       return View('backend.po_receive_products.form')->with(array('sRow'=>$sRow , 'id'=>$id, 'sRowNew'=>$sRowNew ,
        'sProduct'=>$sProduct,
        'sProductUnit'=>$sProductUnit,
    ...
    public function form($id=NULL)
    {
      ...
      try {
        ...
        echo $e->getMessage();
        \DB::rollback();
        return redirect()->action('backend\Po_receive_productsController@index')->with(['alert'=>\App\Models\Alert::e($e)]);
      }
    }
