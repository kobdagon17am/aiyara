         ...
         <div class="tab-content m-t-15">
           ...
           <div class="tab-pane" id="address" role="tabpanel">
             ...
             <div class="tab-pane active" id="address" role="tabpanel">
               ...
               <div class="card-block p-b-0" style="padding:10px">
                 ...
                 <div class="form-radio">
                   <div class="row">
                     <div class="radio radio-inline">
                       <label>
                        <input type="radio" onchange="sent_address('sent_address')" id="sent_address_check" name="receive"
                     ...
                     <div class="radio radio-inline">
                       <label>
                         <input type="radio" id="sent_address_card_check" onchange="sent_address('sent_address_card',{{ $address_card->provinces_id }})" name="receive"
                         value="sent_address_card">
                     ...
                     <div class="radio radio-inline">
                       <label>
                         <input type="radio" id="sent_office_check" onchange="sent_address('sent_office')" name="receive"
                         value="sent_office">
                 ...
                 <div id="sent_address">
                   <div class="row m-t-5">
                     ...
                     <div class="col-md-6 col-sm-6 col-6">
                       ...
                       <input type="text" class="form-control form-control-bold" placeholder="เบอร์โทรศัพท์"
                       name="tel_mobile" value="{{ $address->tel_mobile }}" readonly="">
                     </div>
                   </div>
                   <div class="row m-t-5">
                     <div class="col-md-6 col-sm-6 col-6">
                   ...
                   <div class="row m-t-5">
                     <div class="col-md-3 col-sm-4 col-4">
                       ...
                       name="house_no" value="{{$address->house_no}}" readonly="">
                     </div>
                     <div class="col-md-5 col-sm-8 col-8">
                       <label>หมู่บ้าน/อาคาร <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="หมู่บ้าน/อาคาร"
                       name="house_name" value="{{ $address->house_name }}" readonly="">
                     </div>
                     <div class="col-md-3 col-sm-12 col-12">
                       <label>หมู่ที่ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="หมู่ที่" name="moo"
                   ...
                   <div class="row m-t-5">
                     <div class="col-sm-4">
                       <label>ถนน</label>
                       <input type="text" class="form-control form-control-bold" placeholder="ถนน" name="road"
                       value="{{ $address->road }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>ตรอก/ซอย </label>
                       <input type="text" class="form-control form-control-bold" placeholder="ตรอก/ซอย" name="soi"
                       value="{{ $address->soi }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>จังหวัด <b class="text-danger">*</b></label>
                       <input type="text" id="provinces_address" class="form-control form-control-bold" placeholder="จังหวัด" name="province"
                     ...
                     <div class="col-sm-4">
                       ...
                       <input type="text" class="form-control form-control-bold" placeholder="เขต/อำเภอ"
                       name="district" value="{{ $address->amphures_name }}" readonly="">
                       {{-- <input type="hidden" name="district" value="{{ $address->amphures_id }}"> --}}
                     </div>
                     <div class="col-sm-4">
                       <label>แขวง/ตำบล <b class="text-danger">*</b> </label>
                       <input type="text" class="form-control form-control-bold" placeholder="แขวง/ตำบล"
                       name="district_sub" value="{{ $address->district_name }}" readonly="">
                       {{-- <input type="hidden" name="district_sub" value="{{ $address->district_id }}"> --}}
                     </div>

                     <div class="col-sm-4">
                       <label>รหัสไปษณีย์ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="รหัสไปษณีย์"
                       name="zipcode" value="{{ $address->zipcode }}" readonly="">
                     </div>
                   </div>
                 ...
                 <div id="sent_address_card" style="display: none;">
                   <div class="row m-t-5">
                     ...
                     <div class="col-md-6 col-sm-6 col-6">
                       <label>เบอร์โทรศัพท์ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="เบอร์โทรศัพท์"
                       name="card_tel_mobile" value="{{ $address->tel_mobile }}" readonly="">
                     </div>
                   </div>
                   <div class="row m-t-5">
                     <div class="col-md-6 col-sm-6 col-6">
                   ...
                   <div class="row m-t-5">
                     <div class="col-md-3 col-sm-4 col-4">
                       <label>บ้านเลขที่ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="บ้านเลขที่"
                       name="card_house_no" value="{{$address_card->card_house_no}}" readonly="">
                     </div>
                     <div class="col-md-5 col-sm-8 col-8">
                       <label>หมู่บ้าน/อาคาร <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="หมู่บ้าน/อาคาร"
                       name="card_house_name" value="{{ $address_card->card_house_name }}" readonly="">
                     </div>
                     <div class="col-md-3 col-sm-12 col-12">
                       <label>หมู่ที่ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="หมู่ที่" name="card_moo"
                       value="{{ $address_card->card_moo }}" readonly="">
                     </div>
                   ...
                   <div class="row m-t-5">
                     <div class="col-sm-4">
                       <label>ถนน</label>
                       <input type="text" class="form-control form-control-bold" placeholder="ถนน" name="card_road"
                       value="{{ $address_card->card_road }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>ตรอก/ซอย </label>
                       <input type="text" class="form-control form-control-bold" placeholder="ตรอก/ซอย"
                       name="card_soi" value="{{ $address_card->card_soi }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>จังหวัด <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="จังหวัด"
                       name="card_province" value="{{ $address_card->card_provinces_name }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>เขต/อำเภอ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="เขต/อำเภอ"
                       name="card_district" value="{{ $address_card->card_amphures_name }}" readonly="">
                       {{-- 	<input type="hidden" name="card_district" value="{{ $address->amphures_id }}"> --}}
                     </div>
                     <div class="col-sm-4">
                       <label>แขวง/ตำบล <b class="text-danger">*</b> </label>
                       <input type="text" class="form-control form-control-bold" placeholder="แขวง/ตำบล"
                       name="card_district_sub" value="{{ $address_card->card_district_name }}" readonly="">
                     </div>

                     <div class="col-sm-4">
                       <label>รหัสไปษณีย์ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="รหัสไปษณีย์"
                       name="card_zipcode" value="{{ $address_card->card_zipcode }}" readonly="">
                     </div>
                   </div>
                 ...
                 <div id="sent_office" style="display: none;">
                   ...
                   <div class="row m-t-5">
                     ...
                     <div class="col-md-6 col-sm-6 col-6">
                       <label>เบอร์โทรศัพท์ <b class="text-danger">*</b></label>
                       <input type="text" class="form-control form-control-bold" placeholder="เบอร์โทรศัพท์"
                       name="receive_tel_mobile" value="{{ $address->tel_mobile }}" readonly="">
                     </div>
                   </div>
                 ...
                 <div id="sent_address_other" style="display: none;">
                   ...
                   <div class="row m-t-5">
                     ...
                     <div class="col-sm-4">
                       ...
                       <select class="js-example-basic-single col-sm-12 sent_address_other" id="province"
                       name="other_province">
                 ...
                 <div class="form-group row m-t-5">
                   ...
                   <div class="col-sm-4">
                     ...
                     <select class="js-example-basic-single col-sm-12 sent_address_other" name="other_district"
                     id="district">
                     <option value=""> Select </option>
                   </select>
                 </div>
                 ...
                 <div class="col-sm-4">
                   ...
                   <select class="js-example-basic-single col-sm-12 sent_address_other" name="other_district_sub"
                   id="district_sub">
                   <option value=""> Select </option>
               ...
               <div class="col-sm-4">
                 ...
                 <input type="text" class="form-control sent_address_other" placeholder="รหัสไปษณีย์"
                 id="other_zipcode" name="other_zipcode" value="">
               </div>
           ...
           <div class="row m-t-5">
             ...
             <a type="button"  href="{{ route('product-list',['type'=>$bill['type']]) }}"
               class="btn btn-warning waves-effect waves-light m-t-20"><i class="fa fa-shopping-cart"></i> เลือกสินค้าเพิ่มเติม</a>



               <button type="button" onclick="next()"
               class="btn btn-primary waves-effect waves-light m-t-20 f-right"><i class="fa fa-credit-card-alt"></i>  ชำระเงิน</button>
               ...
               <div class="row">
                 <div class="col-sm-12 col-md-12 col-xl-12 m-b-30">
                   ...
                   <div class="form-radio">
                     <div class="radio radio-inline">
                       <label>
                         <input type="radio" id="bank" onchange="open_input(1)" name="pay_type" value="1"
                         checked="checked">
                 ...
                 <div class="form-group row">
                   ...
                   <div class="row">
                     <div class="col-xs-6 p-1">
                       <button class="btn btn-success btn-block" type="submit" name="submit" id="submit_upload"
       ...
       <div class="col-md-12">
         <table class="table table-responsive m-b-0">
           ...
           <tr>
             ...
             <td align="right"><strong id="shipping">{{  number_format($bill['shipping'],2) }}</strong> </td>
           </tr>
           <tr>
             <td colspan="2">
              <label class="label label-inverse-warning"> <font id="shipping_detail" style="color: #000"></font> </label>
         ...
         <table class="table table-responsive m-b-0">
           ...
           <tr>
             <td><strong style="font-size: 12px">{{$product_value->product_name}} [{{$product_value->product_amt}}] x
             [{{$giveaway_value['count_free']}}]</strong></td>
             <td align="right"><strong> {{ $product_value->product_amt * $giveaway_value['count_free']}}
 ...
 var premium =  document.getElementById('checkbox13').checked;
  ...
  function check_shipping(provinces_id){
   ...
   $.ajax({
     ...
     data: {_token:'{{ csrf_token()}}',location_id:location_id,provinces_id:provinces_id,price:price,shipping_premium:shipping_premium},
