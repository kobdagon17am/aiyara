...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> รักษาคุณสมบัติท่องเที่ยว </h4>
        </div>
    </div>
</div>
<!-- end page title -->
            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right" >
                    <a class="btn btn-info btn-sm mt-1 class_btn_add " href="{{ route('backend.travel_feature.create') }}">
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.travel_feature.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        rowCallback: function(nRow, aData, dataIndex){
              ...
              var str_U = '';
              if(sU=='1'){
                str_U = '<a href="{{ route('backend.travel_feature.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" style="'+sU+'"><i class="bx bx-edit font-size-16 align-middle"></i></a> ';
              }
              var str_D = '';
              if(sD=='1'){
                ...
                // str_D = '<a href="javascript: void(0);" data-url="{{ route('backend.travel_feature.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete" style="'+sD+'"><i class="bx bx-trash font-size-16 align-middle"></i></a>';
              }
              if(sU!='1' && sD!='1'){
...
function go_to_rem(id){
      if (confirm('Are you sure?')) {
          window.location.replace("{{ route('backend.travel_feature.index') }}/"+id)
      }
    }
</script>
