                    ...
                    <div class="myBorder">
                                ...
                                <div class="col-md-12 d-flex  ">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control" id="txtSearch" name="txtSearch"
                                            style="font-size: 18px !important;color: blue;"
                                            value="{{ @$sRow->invoice_code }}">
                                    </div>
                                    <a class="btn btn-info btn-sm btnSearch " href="#"
                                        style="font-size: 14px !important;padding: 0.7%">
                        ...
                        <div class="form-group row div_data_table ">
                                ...
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="text-lg-center">
                                            <img src="backend/images/users/user.png"
                                                class=" images_users rounded-circle mb-1 float-left float-lg-none"
                                                alt="img" style="width:18%;height: 15%;" />
                                            <h2 class="font-size-15 text-truncate user_code " data-toggle="tooltip"
                                                data-placement="top" title="รหัสสมาชิก">{{ @$sUser[0]->user_code }}</h2>
                                        </div>
                                    </div>
                                    <div class="col-lg-10" style="text-align: left;">
                                        <h5 class="font-size-20 text-truncate mb-lg-2  "><b data-toggle="tooltip"
                                                data-placement="top" title="ชื่อสมาชิก"
                                                class="user_name">{{ @$sUser[0]->user_name }}</b></h5>
                                        <ul class="list-inline mb-0" style="text-align: left;">

                                            <li class="list-inline-item ">
                                                <h5 class="font-size-14  " data-toggle="tooltip" data-placement="top"
                                                    title="รับสินค้าที่"><i
                                                        class="bx bx-home mr-1 text-primary"></i>รับสินค้าที่ : <b><span
                                                            class="user_address">{{ @$sUser[0]->user_address }}</span></b>
                                                </h5>
                                            </li>
                                            ...
                                            @if (@$sUser[0]->status_sent != 3)
                                                <li class="list-inline-item">
                                                    <h5 class="font-size-14  " data-toggle="tooltip" data-placement="top"
                                                        title="วันที่ดำเนินการ"><i
                                                            class="bx bx-calendar mr-1 text-primary"></i>วันที่ดำเนินการ :
                                                        <b><span
                                                                class="action_date">{{ @$sUser[0]->action_date }}</span></b>
                                                    </h5>
                                                </li>

                                                <li class="list-inline-item">
                                                    <h5 class="font-size-14 " data-toggle="tooltip" data-placement="top"
                                                        title="ผู้ดำเนินการ"><i
                                                            class="bx bx-user-check font-size-18 mr-1 text-primary"></i>ผู้ดำเนินการ
                                                        : <b><span
                                                                class="user_action">{{ @$sUser[0]->user_action }}</span></b>
                                                    </h5>
                                                </li>
                                            @ENDIF
                                            ...
                                            <li class="list-inline-item ">
                                                <h5 class="font-size-14  " data-toggle="tooltip" data-placement="top"
                                                    title="สถานะ"><i class="bx bx-task mr-1 text-primary"></i> STATUS :
                                                    <span style="color:red;font-weight: bold;font-size: 16px;"
                                                        class="bill_status">{{ @$sUser[0]->bill_status }}</span>
                                                </h5>
                                            </li>

                                            @if(@$sUser[0]->status_sent==1)
                                            <li class="list-inline-item ">

                                                <a class="btn btn-danger btn-sm waves-effect" title="ใช้กรณีระบบเกิดปัญหา"
                                                    onclick="return confirm('ยืนยันการทำรายการ ใช้เฉพาะกรณีระบบมีปัญหาเท่านั้น!')"
                                                    href="{{ url('backend/pay_product_receipt_001_clear/'.@$sUser[0]->id) }}">
                                                    ล้างสถานะ : สินค้ารอจ่าย
                                                </a>
                                            </li>
                                            @endif
                                            ...
                                            @if (@$sUser[0]->status_sent == 3)
                                                <li class="list-inline-item">
                                                    <h5 class="font-size-14  " data-toggle="tooltip" data-placement="top"
                                                        title="วันเวลาที่จ่าย"><i
                                                            class="bx bx-calendar mr-1 text-primary"></i>วันเวลาที่จ่าย :
                                                        <b><span class="pay_date">{{ @$sUser[0]->pay_date }}</span></b>
                                                    </h5>
                                                </li>
                                                ...
                                                <li class="list-inline-item">
                                                    <h5 class="font-size-14 " data-toggle="tooltip" data-placement="top"
                                                        title="ผู้จ่าย"><i
                                                            class="bx bx-user-check font-size-18 mr-1 text-primary"></i>ผู้จ่าย
                                                        : <b><span class="pay_user">{{ @$sUser[0]->pay_user }}</span></b>
                                                    </h5>
                                                </li>
                                            @ENDIF
                            ...
                            <div class="col-md-12 text-center div_btn_save_004 " style="display: none;">
                                <br>
                                <button type="submit"
                                    class="btn btn-primary btn-sm waves-effect font-size-16 btnSave004 ">
                            ...
                            <div class="col-md-12 text-center div_btn_save_cancel " style="display: none;">
                                <br>
                                <a type="button" href="javascript:;" data-invoice_code="{{ @$sUser[0]->invoice_code }}"
                                    data-id="{{ @$sUser[0]->id }}"
                                    class="btn btn-primary btn-sm waves-effect font-size-16 btnCancel ">
                                    <i class="bx bx-lock font-size-16 align-middle mr-1"></i>
                                    ปลดล็อคเพื่อจ่ายสินค้าอีกครั้ง
                                </a>
                            </div>
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                location.replace(
                                    '{{ url('backend/pay_product_receipt') }}/' +
                                    id + '/edit');
                            }
                        })
    ...
    <script type="text/javascript">
        ...
        $(function() {
            oTable0001 = $('#data-table-0001').DataTable({
                ...
                columns: [{
                        data: 'column_001',
                        title: '<span style="vertical-align: middle;"> เลขที่ใบเสร็จ </span> ',
                        className: 'text-center w150 '
                    },
                    {
                        data: 'column_002',
                        title: '<center><span style="vertical-align: middle;"> รายการสินค้า. </span></center> ',
                        className: 'text-left '
                    },
                    {
                        data: 'column_003',
                        title: '<span style="vertical-align: middle;"> พิมพ์ใบเสร็จ </span> ',
                        className: 'text-center w150 '
                    },
                ],
        ...
        $(function() {
            oTable0002 = $('#data-table-0002').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'column_001',
                        title: '<center> รายการครั้งที่จ่ายสินค้า </center> ',
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['status_cancel'] == 1) {
                        ...
                        $("td:eq(2)", nRow).html("<br>ยกเลิกแล้ว").css({
                            'color': 'red'
                        });
                    ...
                    $(function() {
                        oTable0003 = $('#data-table-0003').DataTable({
                            ...
                            rowCallback: function(nRow, aData, dataIndex) {
                                ...
                                if (aData['status_sent'] == 3 || aData['status_sent'] ==
                                    4) {
                                    $(".div_btn_save").hide();
                            ...
                            $.ajax({
                                ...
                                success: function(data) {
                                    ...
                                    if (data == "No_changed") {
                                        ...
                                        var txtSearch = $("input[name='txtSearch']")
                                            .val();
                                        // ก่อนบันทึก recheck อีกรอบ เผื่อมีสินค้าเข้ามาเติมเต็มแล้ว
                                        // $.ajax({
                                        //        url: " {{ url('backend/ajaxSearch_bill_db_orders') }} ",
                            ...
                            success: function(data) {
                                ...
                                setTimeout(function() {
                                    ...
                                    if (time_pay == 1) {
                                        ...
                                        location.replace(
                                            '{{ url('backend/pay_product_receipt_001') }}'
                                        );
