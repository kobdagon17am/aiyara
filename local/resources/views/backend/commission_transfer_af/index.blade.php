...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.commission_transfer_af.datatable') }}',
          data: function ( d ) {
            d.Where={};
...
// วันที่ทำรายการ  ชื่อ-นามสกุล  ธนาคารปลายทาง เลขที่บัญชีธนาคารผู้รับโอน  จำนวนเงิน ผลการโอน  หมายเหตุ
        columns: [
            {data: 'id', title :'ID', className: 'text-center w50'},
            {data: 'cus_name', title :'<center>ชื่อ-นามสกุล   </center>', className: 'text-left'},
            {data: 'destination_bank', title :'<center>ธนาคารปลายทาง </center>', className: 'text-left'},
            {data: 'transferee_bank_no', title :'<center>เลขที่บัญชีธนาคารผู้รับโอน</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนเงิน</center>', className: 'text-left'},
            {data: 'transfer_result', title :'<center>ผลการโอน</center>', className: 'text-left'},
            {data: 'note', title :'<center>หมายเหตุ</center>', className: 'text-left'},
            {data: 'action_date', title :'<center>วันที่ทำรายการ</center>', className: 'text-left'},
