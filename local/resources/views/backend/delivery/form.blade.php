              ...
              @endif
                {{ csrf_field() }}
                      ...
                      <div class="myBorder">
                          ...
                          <div class="form-group row">
                            <label for="delivery_tatus" class="col-md-2 col-form-label">สถานะการจัดส่ง :</label>
                            <div class="col-md-10">
                              <input class="form-control" type="text" value="{{ @$sRow->delivery_tatus }}" name="delivery_tatus" >
                            </div>
                          </div>
