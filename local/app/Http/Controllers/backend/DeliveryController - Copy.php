...
class DeliveryController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      //     SELECT id,code_order,customers_id_fk,business_location_id_fk,created_at,action_user,now(),2,shipping_price 
      //     FROM db_orders where code_order<>'' AND delivery_location<>0  ; 
      //   ");
