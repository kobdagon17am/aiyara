...
@section('css')
    <style>
        .bg_product {
            background-image: url("{{ asset('frontend/salepage/Alada/bg.png') }}");
            /* Full height */
            height: 100%;
...
@section('content')
    <div class="container">
        <div class="row justify-content-center">
            <img src="{{ asset('frontend/salepage/Alada_ca/01.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/02.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/03.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/04.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/05.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/06.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/07.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/08.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/09.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/10.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        ...
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/11.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/12.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>


        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Alada_ca/13.jpg') }}" class="img-fluid"
                alt="เพราะผิวหน้าเราควบคุมไม่ได้ Alada">
        </div>
            ...
            <div class="row justify-content-md-center">
                ...
                <div class="col-md-auto text-center">
                    ...
                    <div class="justify-content-center" style="margin-top: 10px">
                        ...
                        <p style="color: #fff">คุณ {{ $rs['data']->first_name }} {{ $rs['data']->last_name }} รหัส
                            {{ $rs['data']->user_name }}
                            @if ($rs['data']->email)
                        ...
                        @if ($rs['data']->tel_number)
                            <a href="tel:{{ $rs['data']->tel_number }}" class="btn btn-success"><i
    ...
    <nav class="float-action-button">
        ...
        @endif
        @if ($rs['data']->url_line)
            <a href="https://line.me/ti/p/{{ $rs['data']->url_line }}" class="buttons" title="line"
