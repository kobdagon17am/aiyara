...
@section('content')
    ...
    <main role="main">
        <div class="row justify-content-center">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-01.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-02.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-03.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-04.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-05.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-06.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-07.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-08.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-09.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>

        <div class="row justify-content-center mt-2">
            <img src="{{ asset('frontend/salepage/Aimmura/ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง-10.jpg') }}" class="img-fluid"
                alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง">
        </div>
          ...
          <div class="container bg_product mt-2">
            ...
            <div class="row text-center mt-2 mb-5">
              ...
              <div class="col-6 col-sm-6 col-lg-3">
                <img src="{{ asset('frontend/salepage/Aimmura/Aimmura X+Box.png') }}" class="img-fluid" alt="Responsive image">
                <h2>3,000 บาท</h2>

                <p><a class="btn btn-success" href="#"  style="font-size: 23px"> สั่งซื้อ </a></p>
              </div><!-- /.col-lg-4 -->
              <div class="col-6 col-sm-6 col-lg-3">
                <img src="{{ asset('frontend/salepage/Aimmura/aimmura-E_box.png') }}" class="img-fluid" alt="Responsive image">
                <h2>1,900 บาท</h2>
              ...
              <div class="col-6 col-sm-6 col-lg-3">
                <img src="{{ asset('frontend/salepage/Aimmura/aimmura-V_box.png') }}" class="img-fluid" alt="Responsive image">
                <h2>2,000 บาท</h2>
                <p><a class="btn btn-success" href="#"  style="font-size: 23px"> สั่งซื้อ </a></p>
              </div><!-- /.col-lg-4 -->
            </div><!-- /.row -->
            ...
            <div class="row mt-4">
              <div class="col-6 mt-2"> <img src="{{ asset('frontend/salepage/Aimmura/bg_tranfer_1.png') }}" class="img-fluid"
               alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง"></div>
               <div class="col-6 text-right"> <img src="{{ asset('frontend/salepage/Aimmura/bg_tranfer_2.png') }}" class="img-fluid"
                 alt="ปัจจัยสิ่งแวดล้อมและพฤติกรรมเสี่ยง"></div>
        ...
        <nav class="float-action-button">
            ...
            @if ($rs['data']->tel_mobile)
                <a href="tel:{{ $rs['data']->tel_mobile }}" class="buttons" title="Phone" data-toggle="tooltip"
                    data-placement="left">
                    <svg class="ico_d" width="40" height="40" viewBox="0 0 39 39" fill="none"
                        xmlns="http://www.w3.org/2000/svg" style="margin-top: -16px;transform: rotate(0deg);">
