...
#===========================================================================================================================================================
  ...
  #=========================================================================================================================================================
  	...
  	Route::post('testme', 'HomeController@testme');
 	  Route::get('test_general_takeout_remove', 'HomeController@test_general_takeout_remove');


    Route::get('test_sql', 'HomeController@test_sql');
    Route::get('test_add_delivery/{order_id}', 'HomeController@test_add_delivery');
...
// End รับสินค้าเข้าจากการโอนระหว่างสาขา
    ...
    Route::post('check_stock/datatable_print', 'Check_stockController@DatatablePrint')->name('check_stock.datatable_print');
    ...
    Route::post('check_money_daily_report_pint', 'Check_money_dailyController@check_money_daily_report_pint');
