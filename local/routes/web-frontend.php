...
Route::get('product_list_2_select_c/{c_id?}','Frontend\ProductController@product_list_2_select_c')->name('product_list_2_select_c');
...
Route::get('product_list_3_select_c/{c_id?}','Frontend\ProductController@product_list_3_select_c')->name('product_list_3_select_c');
...
Route::get('product_list_4_select_c/{c_id?}','Frontend\ProductController@product_list_4_select_c')->name('product_list_4_select_c');
...
Route::get('product_list_5_select_c/{c_id?}','Frontend\ProductController@product_list_5_select_c')->name('product_list_5_select_c');
...
Route::get('product_list_6_select_c/{c_id?}','Frontend\ProductController@product_list_6_select_c')->name('product_list_6_select_c');
