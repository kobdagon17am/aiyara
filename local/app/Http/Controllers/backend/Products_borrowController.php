...
class Products_borrowController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return view('backend.products_borrow.index');
   ...
   public function form($id=NULL)
    {
      ...
      try {
          if( $id ){
            ...
            $sRow = new \App\Models\Backend\Products_borrow;
          }
          ...
          \DB::commit();
           ...
           return redirect()->to(url("backend/Products_borrow/".$sRow->id."/edit?role_group_id=".request('role_group_id')."&menu_id=".request('menu_id')));
