...
<body>
    ...
    <li class="{{ (request()->is('profile')) ? 'active' : '' }}">
			<a href="{{route('profile')}}">
				<span class="pcoded-micon"><i class="fa fa-wpforms text-success"></i><b>{{ trans(message.myprofile) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.myprofile) }}</span>
		...
		<li class="{{ (request()->is('tree_view')) ? 'active' : '' }}">
			<a href="{{route('tree_view')}}">
				<span class="pcoded-micon"><i class="fa fa-sitemap text-success"></i><b>{{ trans(message.jobstructure) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.jobstructure) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
		...
		<li class="{{ (request()->is('direct-sponsor')) ? 'active' : '' }}">
			<a href="{{route('direct-sponsor')}}">
				<span class="pcoded-micon"><i class="fa fa-group text-success"></i><b>{{ trans(message.directsponsor) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.directsponsor) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
    ...
    <li class="pcoded-hasmenu {{ (request()->is('commission_bonus_transfer') || request()->is('commission-per-day')
      ...
      ||  request()->is('commission_bonus_transfer_aistockist') ||  request()->is('commission_bonus_transfer_af') ||  request()->is('commission_bonus_transfer_member'))  ? 'pcoded-trigger' : '' }}" dropdown-icon="style3" subitem-icon="style7">
        <a href="javascript:void(0)">
          <span class="pcoded-micon"><i class="fa fa-line-chart text-success"></i><b>{{ trans(message.commission) }}</b></span>
          <span class="pcoded-mtext">{{ trans(message.commission) }}</span>
          <span class="pcoded-mcaret"></span>
        </a>
        ...
        <ul class="pcoded-submenu">
          <li class="{{ (request()->is('commission_bonus_transfer')) ? 'active' : '' }}">
            <a href="{{route('commission_bonus_transfer')}}">
              ...
              <span class="pcoded-mtext">{{ trans(message.commission_bonus) }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
          ...
          <li class="{{ (request()->is('commission-per-day') || request()->is('commission_faststart*') || request()->is('commission_matching*') ) ? 'active' : '' }}">
            <a href="{{route('commission-per-day')}}">
              <span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
              <span class="pcoded-mtext">{{ trans(message.scoreandbonus) }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
          ...
          <li class="{{ (request()->is('commission_bonus_transfer_aistockist')) ? 'active' : '' }}">
            <a href="{{route('commission_bonus_transfer_aistockist')}}">
              <span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
              <span class="pcoded-mtext">{{ trans(message.commission_ai-stockist) }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
          ...
          <li class="{{ (request()->is('commission_bonus_transfer_af')) ? 'active' : '' }}">
            <a href="{{route('commission_bonus_transfer_af')}}">
              <span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
              <span class="pcoded-mtext">{{ trans(message.commission_af) }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
          ...
          <li class="{{ (request()->is('commission_bonus_transfer_member')) ? 'active' : '' }}">
            <a href="{{route('commission_bonus_transfer_member')}}">
              <span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
              <span class="pcoded-mtext">{{ trans(message.commission_legal-person }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
      ...
      <li class="{{ (request()->is('taxdata')) ? 'active' : '' }}">
            <a href="{{route('taxdata')}}">
              <span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
              <span class="pcoded-mtext">{{ trans(message.withholdingtax) }}</span>
              <span class="pcoded-mcaret"></span>
            </a>
          </li>
    ...
    @if($canAccess)
		<li class="pcoded-hasmenu {{ (request()->is('cart/*') || request()->is('product-detail/*') || request()->is('product-list/*')  || request()->is('product-status') || request()->is('cart_payment/*') ) ? 'pcoded-trigger' : '' }}" dropdown-icon="style3" subitem-icon="style7">
			<a href="javascript:void(0)">
				<span class="pcoded-micon"><i class="fa fa-shopping-cart text-success"></i><b>{{ trans(message.order) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.order) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
			<ul class="pcoded-submenu">
				...
				<li class="{{ (request()->is('cart/1') || request()->is('product-list/1') || request()->is('product-detail/1/*') || request()->is('cart_payment/1') )  ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>1])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.qualification) }}</span>
				...
				<li class="{{ (request()->is('cart/2') || request()->is('product-list/2') || request()->is('product-detail/2/*') || request()->is('cart_payment/2') ) ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>2])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.qualificationpermonth) }}</span>
				...
				<li class="{{ (request()->is('cart/3') || request()->is('product-list/3') || request()->is('product-detail/3/*') || request()->is('cart_payment/3') ) ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>3])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext" style="font-size: 13px">{{ trans(message.qualificationtravel) }}</span>
				...
				<li class="{{ (request()->is('cart/4') || request()->is('product-list/4') || request()->is('product-detail/4/*') || request()->is('cart_payment/4') ) ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>4])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.aistockistrefill) }}</span>
				...
				<li class="{{ (request()->is('cart/5') || request()->is('product-list/5') || request()->is('product-detail/5/*') || request()->is('cart_payment/5') ) ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>5])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.aivoucher) }}</span>
				...
				<li class="{{ (request()->is('cart/6') || request()->is('product-list/6') || request()->is('product-detail/6/*') || request()->is('cart_payment/6') ) ? 'active' : '' }}">
					<a href="{{route('product-list',['type'=>6])}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.course) }}</span>
    ...
    <li class="{{ (request()->is('ai-cash')) ? 'active' : '' }}">
      <a href="{{route('ai-cash')}}">
        <span class="pcoded-micon"><i class="fa fa-money text-success"></i><b>{{ trans(message.Ai-Cash) }}</b></span>
        <span class="pcoded-mtext">{{ trans(message.Ai-Cash) }}</span>
        <span class="pcoded-mcaret"></span>
      </a>
    </li>
    ...
    <li class="{{ (request()->is('giftvoucher_history')) ? 'active' : '' }}">
      <a href="{{route('giftvoucher_history')}}">
        <span class="pcoded-micon"><i class="fa fa-gift text-success"></i><b>{{ trans(message.Ai-Voucher) }}</b></span>
        <span class="pcoded-mtext">{{ trans(message.Ai-Voucher) }}</span>
        <span class="pcoded-mcaret"></span>
      </a>
    </li>
		...
		<li class="{{ (request()->is('ai-stockist')) ? 'active' : '' }}">
			<a href="{{route('ai-stockist')}}">
				<span class="pcoded-micon"><i class="ti-wallet text-success"></i><b>{{ trans(message.Ai-Stockist) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.Ai-Stockist) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
    ...
    <li class="{{ (request()->is('course'))  ? 'active' : '' }}">
			<a href="{{route('course')}}">
				<span class="pcoded-micon"><i class="fa fa-black-tie text-success"></i><b>{{ trans(message.courseevent) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.courseevent) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
		...
		<li class="{{ (request()->is('product-history') || request()->is('product-history/*') || request()->is('cart-payment-history/*'))  ? 'active' : '' }}">
			<a href="{{route('product-history')}}">
				<span class="pcoded-micon"><i class="ti-receipt text-success"></i><b>{{ trans(message.history) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.history) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
	...
	{{-- 	<li class="{{ (request()->is('comission')) ? 'active' : '' }}">
			<a href="{{route('comission')}}">
				<span class="pcoded-micon"><i class="fa fa-line-chart text-success"></i><b>{{ trans(message.history) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.history) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li> --}}
		...
		<li class="pcoded-hasmenu {{ (request()->is('reward-history') || request()->is('benefits') || request()->is('travel*') )  ? 'pcoded-trigger' : '' }}" dropdown-icon="style3" subitem-icon="style7">
			<a href="javascript:void(0)">
				<span class="pcoded-micon"><i class="fa fa-gift text-success"></i><b>{{ trans(message.benefits) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.benefits) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
			<ul class="pcoded-submenu">
				<li class="{{ (request()->is('reward-history')) ? 'active' : '' }}">
					<a href="{{route('reward-history')}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.award) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="{{ (request()->is('travel*')) ? 'active' : '' }}">
					<a href="{{route('travel')}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.travelpromotion) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
    ...
    <li class="pcoded-hasmenu {{ (request()->is('salepage/*') || request()->is('s*') )  ? 'pcoded-trigger' : '' }}" dropdown-icon="style3" subitem-icon="style7">
			<a href="javascript:void(0)">
				<span class="pcoded-micon"><i class="fa fa-chrome text-success"></i><b>{{ trans(message.salepage) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.salepage) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
        ...
        <li class="">
					<a href="{{url($user_name.'/1')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.aiyara) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="">
					<a href="{{url($user_name.'/2')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.aimmura) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="">
					<a href="{{url($user_name.'/3')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.Cashewy) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
        ...
        <li class="">
					<a href="{{url($user_name.'/4')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.aifacad) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="">
					<a href="{{url($user_name.'/5')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.ailada) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="">
					<a href="{{url($user_name.'/6')}}" target="_blank">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.trimMax) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="{{ (request()->is('salepage/setting')) ? 'active' : '' }}">
					<a href="{{route('salepage/setting')}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.setting) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
				...
				<li class="{{ (request()->is('salepage/vip-report')) ? 'active' : '' }}">
					<a href="{{route('salepage.vip-report')}}">
						<span class="pcoded-micon"><i class="ti-angle-right text-success"></i></span>
						<span class="pcoded-mtext">{{ trans(message.vipreport) }}</span>
						<span class="pcoded-mcaret"></span>
					</a>
				</li>
			</ul>
		...
		<li class="{{ (request()->is('news') || request()->is('news_detail/*')) ? 'active' : '' }}">
			<a href="{{route('news')}}">
				<span class="pcoded-micon"><i class="fa fa-newspaper-o text-success"></i><b>{{ trans(message.newsactivity) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.newsactivity) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
			...
			<a href="{{route('message')}}">
				<span class="pcoded-micon"><i class="fa fa-send text-success"></i><b>{{ trans(message.contactquestion) }}</b></span>
				<span class="pcoded-mtext">{{ trans(message.contactquestion) }}</span>
				<span class="pcoded-mcaret"></span>
			</a>
		</li>
