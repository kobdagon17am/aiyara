              ...
              "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                  ...
                  rowCallback: function(nRow, aData, dataIndex){
                    ...
                    if(sU!=''&&sD!=''){
                      ...
                      // if(aData['status_sent']==0 || aData['status_sent']==2){
                          ...
                          $('td:last-child', nRow).html(''
                            ...
                            + '<a href="javascript: void(0);" data-url="{{ route('backend.pay_product_receipt.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete2 "  data-id="'+aData['id']+'"  style="'+sD+'" ><i class="bx bx-trash font-size-16 align-middle"></i></a>'
                          ).addClass('input');
                        ...
                        rowCallback: function(nRow, aData, dataIndex){
                          ...
                          if(sU!=''&&sD!=''){
                            ...
                            // if(aData['status_sent']==0 || aData['status_sent']==2){
                                ...
                                $('td:last-child', nRow).html(''
                                  + '<a href="{{ url('backend/pay_product_receipt') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" style="'+sU+'" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                                  + '<a href="javascript: void(0);" data-url="{{ route('backend.pay_product_receipt_001.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete2 " data-id="'+aData['id']+'" style="'+sD+'" ><i class="bx bx-trash font-size-16 align-middle"></i></a>'
                                ).addClass('input');
