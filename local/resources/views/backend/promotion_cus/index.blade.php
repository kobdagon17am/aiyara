                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-group">
                            <label for="pstatus" class="col-form-label"> รหัสคูปอง : </label>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                <label for="pstatus" class="col-form-label"> รหัสลูกค้า : </label>
                                <select id="customers_id_fk" name="customers_id_fk"
                                    class="form-control select2-templating ">
                                    <option value="">-Select-</option>
                                </select>
                            </div>
                        ...
                        <div class="col-6 align-self-end">
                            <div class="form-group">
                                <button class="btn btn-info btn-sm btnSearch01"
                                    style="font-size: 14px !important;margin-left: 0.8%;">
                                    <i class="bx bx-search align-middle "></i> SEARCH
                                </button>
                                <button class="btn btn-dark btn-sm" style="font-size: 14px !important;margin-left: 0.8%;"
                                    id="clearFilter">
                        ...
                        <div class="col-4 text-right">
                            <a class="btn btn-info btn-sm mt-1 font-size-16 "
                                href="{{ route('backend.promotion_cus.create') }}">
    ...
    <script>
        $(document).ready(function() {
          ...
          $("#promotion_code").select2({
                ...
                placeholder: '-Select-',
                ajax: {
                    url: " {{ url('backend/ajaxGetCoupong') }} ",
                    type: 'POST',
                    dataType: 'json',
                    delay: 250,
                    cache: false,
            ...
            oTable = $('#data-table').DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        ...
                        d.customers_id_fk = $('#customers_id_fk').val();
                        d.promotion_code = $('#promotion_code').val();
                        // d.Where={};
                ...
                columns: [{
                    ...
                    {
                        data: 'pcode',
                        name: 'promotions.pcode',
                        title: '<center>Pro Code</center>',
                        className: 'text-center'
                    },
                    {
                        data: 'promotion_name',
                        name: 'db_promotion_code.promotion_id_fk',
                        title: '<center>ชื่อคูปอง</center>',
                        className: 'text-left'
                    },
                    {
                        data: 'pro_sdate',
                        name: 'db_promotion_code.pro_sdate',
                        title: '<center>วันเริ่มต้นโปร</center>',
                        className: 'text-center'
                    },
                    {
                        data: 'pro_edate',
                        name: 'db_promotion_code.pro_edate',
                        title: '<center>วันสิ้นสุดโปร</center>',
                        className: 'text-center'
                    },
                    // `status` int(1) DEFAULT '1' COMMENT 'การใช้งาน/การแสดงผล 1=แสดงผล,0=ปิดการแสดง',
                    {
                        data: 'status',
                        name: 'db_promotion_code.status',
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    var str_U = '';
                    if (sU == '1') {
                        str_U = '<a href="{{ route('backend.promotion_cus.index') }}/' + aData['id'] +
