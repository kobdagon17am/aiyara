            ...
            {{ csrf_field() }}
                ...
                <div class="row" >
                  <div class="col-8">
                        ...
                        <div class="form-group row">
                        <label for="" class="col-md-3 col-form-label"><i class="bx bx-play"></i>รหัสสินค้า : ชื่อสินค้า </label>
                        <div class="col-md-7">
...
<div class="modal fade" id="setToWarehouseModal" tabindex="-1" role="dialog" aria-labelledby="setToWarehouseModalTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered modal-lg " role="document" style="max-width: 1000px !important;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="setToWarehouseModalTitle"><b><i class="bx bx-play"></i>เลือกคลัง </b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row" >
                  ...
                  <div class="col-md-12" >
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                          <span id="from_wh" style="text-align: left !important;"><b> <!-- คลังต้นทาง : WAREHOUSE/คลัง 1 > คลังเก็บ/Zone-1/Shelf-1/ชั้น>1 --></span>
                          <input type="hidden" id="stocks_id_fk">
                        </div>
                      </div>
                    </div>
                ...
                <div class="row" >
                    <div class="col-md-6 " >
                      <div class="form-group row">
                        ...
                        <div class="col-md-9">
                            ...
                            @if(@$User_branch_id!=0)
                             <select id="branch_id_fk_c" name="branch_id_fk_c" class="form-control select2-templating check_dub_warehouse " >
                             @if(@$sBranchs)
                                @foreach(@$sBranchs AS $r)
                                @if(@$r->id==$User_branch_id)
                                <option value="{{$r->id}}" {{ (@$r->id==@$sRow->branch_id_fk)?'selected':'' }} >
                    ...
                    <div class="col-md-6 " >
                      <div class="form-group row">
                            <label for="" class="col-md-2 col-form-label"> คลัง : </label>
                            <div class="col-md-10">
                              <select id="warehouse_id_fk_c" name="warehouse_id_fk_c" class="form-control select2-templating check_dub_warehouse " required >
                  ...
                  <div class="row" >
                    <div class="col-md-6 " >
                       <div class="form-group row">
                            ...
                            <div class="col-md-9">
                              <select id="zone_id_fk_c" name="zone_id_fk_c" class="form-control select2-templating check_dub_warehouse " required >
                    ...
                    <div class="col-md-6 " >
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select id="shelf_id_fk_c"  name="shelf_id_fk_c" class="form-control select2-templating check_dub_warehouse " required >
    ...
    $(function() {
        ...
        "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
           ...
           columns: [
                  ...
                  {data: 'warehouses_from', title :'<center>จากคลัง </center>', className: 'text-center'},
    	            {data: 'amt', title :'<center>จำนวนที่ต้องการโอน </center>', className: 'text-center'},
                  {data: 'warehouses_to',   title :'<center>โอนย้ายไปที่คลัง</center>', className: 'text-center',render: function(d) {
                      if(d!='0'){
                         return d;
                       }else{
                  ...
                  var info = $(this).DataTable().page.info();
                    ...
                    if(aData['warehouse_id_fk']>0){
                      ...
                      $('td:last-child', nRow).html(''
                        + '<a href="#" class="btn btn-sm btn-primary btnSetToWarehouse " data-id="'+aData['id']+'" stocks_id_fk="'+aData['stocks_id_fk']+'"  ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                        // + '<a href="javascript: void(0);" data-url="{{ route('backend.transfer_choose.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"  ><i class="bx bx-trash font-size-16 align-middle"></i></a>'
                        + '<a href="javascript: void(0);" data-url="{{ route('backend.transfer_choose.index') }}/'+aData['id']+'" data-id="'+aData['id']+'" data-table="db_transfer_choose" data-file="" class="btn btn-sm btn-danger remove_01 "><i class="bx bx-trash font-size-16 align-middle"></i></a>'
                      ).addClass('input');
                    }
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
      ...
      // $("#exampleModalCenter").modal({ show : true });
        ...
        $('.check_dub_warehouse').change(function() {

           $(".myloading").show();

           var stocks_id_fk = $('#stocks_id_fk').val();
           var branch_id_fk_c = $('#branch_id_fk_c').val();
           var warehouse_id_fk_c = $('#warehouse_id_fk_c').val();
           var zone_id_fk_c = $('#zone_id_fk_c').val();
           var shelf_id_fk_c = $('#shelf_id_fk_c').val();
