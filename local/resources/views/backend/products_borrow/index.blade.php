...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> สินค้าเบิก / ยืม </h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        columns: [
            ...
            {data: 'return_date', title :'<center>วันที่รับเบิก </center>', className: 'text-center'},
            {data: 'reason', title :'<center>เหตุผล </center>', className: 'text-center'},
            // {data: 'subwarehouse_name', title :'<center>คลังย่อย </center>', className: 'text-center'},
