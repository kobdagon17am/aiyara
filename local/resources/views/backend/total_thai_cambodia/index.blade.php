...
// วัน เดือน ปี  จำนวนรวม  จำนวนเงินสดรวม  จำนวนเงินโอนรวม จำนวนเงินเครดิตรวม  จำนวนผลต่างกัน
        columns: [
            {data: 'id', title :'ID', className: 'text-center w50'},
            {data: 'action_date', title :'<center>วันที่ทำรายการ</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนรวม</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนเงินสดรวม</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนเงินโอนรวม</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนเงินเครดิตรวม</center>', className: 'text-left'},
            {data: 'amount', title :'<center>จำนวนผลต่างกัน</center>', className: 'text-left'},
