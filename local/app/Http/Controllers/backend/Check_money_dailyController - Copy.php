...
class Check_money_dailyController extends Controller
{
   ...
   public function create()
    ...
    public function store(Request $request)
    {
      ...
      array:8 [▼
      "id" => "1"
      "sum_total_price2" => "4450"
      "_token" => "T9EgYNNVIbC3Oo2hjBfYP00D0uS38OgQaMn5Youi"
      "total_money" => "4450"
      "sent_money_type" => "1"
      "bank" => null
      "sent_money" => "0"
    ...
    public function DatatableSentMoney(Request $req){
      ...
      if(isset($req->id)){
        ...
        $sTable = DB::select("  SELECT *,1 as remark FROM db_sent_money_daily WHERE date(db_sent_money_daily.updated_at)=CURDATE() UNION ALL
          SELECT *,2 as remark FROM db_sent_money_daily WHERE date(db_sent_money_daily.updated_at)=CURDATE() GROUP BY sender_id ");
      }
