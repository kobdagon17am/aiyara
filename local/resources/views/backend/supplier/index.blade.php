                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4 text-right">
                            <a class="btn btn-info btn-sm mt-1 class_btn_add "
        ...
        $(function() {
            oTable = $('#data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'txt_desc',
                        title: '<center>ชื่อ Supplier </center>',
                        className: 'text-center'
                    },
                    {
                        data: 'tel',
                        title: '<center>เบอร์โทร</center>',
                        className: 'text-center'
                    },
                    {
                        data: 'addr',
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    var str_U = '';
                    if (sU == '1') {
                        str_U = '<a href="{{ route('backend.supplier.index') }}/' + aData['id'] +
