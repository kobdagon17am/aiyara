...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty($sRow) )
              <form action="{{ route('backend.supplier.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.supplier.update', @$sRow->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              @endif
                {{ csrf_field() }}
                      ...
                      <div class="myBorder">
                            ...
                            <div class="form-group row">
                                <label for="txt_desc" class="col-md-3 col-form-label">ชื่อ Supplier :</label>
                                <div class="col-md-9">
                            ...
                            <div class="form-group row">
                                <label for="tel" class="col-md-3 col-form-label">เบอร์โทรติดต่อ :</label>
                                <div class="col-md-9">
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ url("backend/supplier") }}">
