...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> รายการบิลการจำหน่ายสินค้าหน้าร้าน  </h4>
        </div>
    </div>
</div>
<!-- end page title -->
...
<div class="row">
            ...
            {{ csrf_field() }}
                ...
                <div class="row">
                  <div class="col-8">
                  	...
                  	<div class="form-group row">
                          <div class="col-md-12">
                            <span style="font-weight: bold;padding-right: 10px;"><i class="bx bx-play"></i> รายการบิล รอจัดเบิกคลัง / รอจัดส่งลูกค้า </span>
                          </div>
                        </div>
                  </div>
                ...
                <table id="data-table" class="table table-bordered dt-responsive" style="width: 100%;">
                 ...
                 <div class="col-md-8 text-right  " style="">
                    ...
                    <button type="submit" class="btn btn-primary btn-sm waves-effect btnSave01 " style="font-size: 16px;">
                    <i class="bx bx-save font-size-16 align-middle mr-1"></i> บันทึกบิลเบิกสินค้าจากคลัง
                    </button> 
                    &nbsp;
                    &nbsp;
                    &nbsp;

                     <button type="submit" class="btn btn-success btn-sm waves-effect btnSave02 " style="font-size: 16px;">
                    <i class="bx bx-save font-size-16 align-middle mr-1"></i> บันทึกรายการจัดส่ง (ลูกค้า)
                    </button>
  ...
  <div class="myBorder">
    <div style="">
      <div class="form-group row">
        <div class="col-md-12">
          <span style="font-weight: bold;padding-right: 10px;"><i class="bx bx-play"></i> รายการบิลรอเบิกคลัง  </span>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-md-12">
  ...
  <div class="myBorder">
    <div style="">
      <div class="form-group row">
        <div class="col-md-12">
          <span style="font-weight: bold;padding-right: 10px;"><i class="bx bx-play"></i> รายการบิลรอจัดส่งสินค้าให้ลูกค้า  </span>
        </div>
      </div>
      <div class="form-group row">
        <div class="col-md-12">
          <table id="data-table-cus-list" class="table table-bordered dt-responsive" style="width: 100%;">
          </table>
        </div>
      </div>
    </div>
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        ajax: {
          ...
          $(function() {
              ...
              "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                  ...
                  columns: [
                      ...
                      //     return ;
                      // }},
                      {data: 'receipt',   title :'<center>รายการบิล</center>', className: 'text-center ',render: function(d) {
                          if(d){
          ...
          var oTable3;
          $(function() {
              oTable3 = $('#data-table-cus-list').DataTable({
              "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                  processing: true,
                  serverSide: true,
                  scroller: true,
