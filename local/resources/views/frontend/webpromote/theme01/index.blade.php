...
<head>
	...
	<link href="https://fonts.googleapis.com/css?family=Poppins:100,300,500" rel="stylesheet">
		...
		CSS
		============================================= -->
		<link rel="stylesheet" href="../webpromote/theme01/css/linearicons.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/owl.carousel.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/font-awesome.min.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/nice-select.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/magnific-popup.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/bootstrap.css">
		<link rel="stylesheet" href="../webpromote/theme01/css/main.css">
	</head>
	<body>
	<div class="oz-body-wrap">
			...
			<div class="container-fluid">
				<div class="header-wrap">
					<div class="header-top d-flex justify-content-between align-items-center">
						<div class="logo">
							<a href="index.html"><img src="../webpromote/theme01/img/logo.png" alt=""></a>
						</div>
			...
			<div class="container">
				<div class="row fullscreen align-items-center justify-content-center">
					<div class="banner-left col-lg-6">
						<img class="d-flex mx-auto img-fluid" src="../webpromote/theme01/img/header-img.png" alt="">
					</div>
					<div class="col-lg-6">
		...
		<section class="video-area pt-40 pb-40">
			...
			<div class="container">
				<div class="video-content">
					<a href="http://www.youtube.com/watch?v=0O2aH4XLbto" class="play-btn"><img src="../webpromote/theme01/img/play-btn.png" alt=""></a>
		...
		<section class="about-area pt-100 pb-100">
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-lg-6">
						<img class="img-fluid d-flex mx-auto" src="../webpromote/theme01/img/about.png" alt="">
					</div>
				</div>
			</div>
		</section>
		...
		<script src="../webpromote/theme01/js/vendor/jquery-2.2.4.min.js"></script>
		<!--<script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>-->
		<script src="../webpromote/theme01/js/vendor/bootstrap.min.js"></script>
		<script src="../webpromote/theme01/js/jquery.ajaxchimp.min.js"></script>
		<script src="../webpromote/theme01/js/owl.carousel.min.js"></script>
		<script src="../webpromote/theme01/js/jquery.nice-select.min.js"></script>
		<script src="../webpromote/theme01/js/jquery.magnific-popup.min.js"></script>
		<script src="../webpromote/theme01/js/jquery.counterup.min.js"></script>
		<script src="../webpromote/theme01/js/waypoints.min.js"></script>
		<script src="../webpromote/theme01/js/main.js"></script>
	</body>
</html>
