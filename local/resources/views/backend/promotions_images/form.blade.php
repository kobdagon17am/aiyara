...
<div class="row">
    <div class="col-10">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> Promotion Images </h4>
    ...
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              ...
              @if( empty($sRow) )
              <form action="{{ route('backend.promotions_images.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input type="hidden" name="promotion_id_fk" value="{{@$sRowNew->id}}" >
              @else
              <form action="{{ route('backend.promotions_images.update', @$sRow->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="myBorder">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="file" accept="image/*" id="image01" name="image01" class="form-control" OnChange="showPreview_01(this)" {{ (empty(@$sRow->promotion_img))?'required':'' }} >
                                  @IF(!empty(@$sRow->promotion_img))
                                  <img id="imgAvatar_01" src="{{ $sRow->img_url }}{{ @$sRow->promotion_img }}" width="300px" > 
                                  @ELSE
