          ...
          <div class="form-group row">
            <div class="col-md-12">
              <span style="font-weight: bold;padding-right: 10px;"><i class="bx bx-play"></i> รายการประวัติการรับสินค้าจาก Supplier </span>
                <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.po_supplier_products_get.create') }}/{{@$sRow->id}}" style="float: right;" >
                <i class="bx bx-plus align-middle mr-1"></i><span style="font-size: 14px;">เพิ่มประวัติการสินค้า</span>
              </a>
            </div>
          </div>
          <div class="form-group row">
