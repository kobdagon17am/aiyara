                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['status'] == 1) {
                        ...
                        $('td:last-child', nRow).html(''
                            ...
                            // วุฒิเพิ่ม
                            +
                            '<a href="{{ url('backend/pick_warehouse/print_requisition_detail_real_remain/') }}/' +
                            aData['id'] +
                            ...
                            ' & remain=1 " class="btn btn-sm btn-primary"  data-toggle="tooltip" data-placement="left" title="อนุมัติเบิกจากคลัง" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                        ...
                        $('td:last-child', nRow).html(''
                            ...
                            '/edit?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="แก้ไขใบเบิก/ยกเลิก" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '

                            +
                            '<a href="{{ url('backend/pick_warehouse') }}/' + aData['id'] +
                            '/qr?remain=1" class="btn btn-sm btn-info" data-toggle="tooltip" data-toggle="tooltip" data-placement="left" title="Scan QR-Code / จัดส่ง" >จัดส่ง</a> '
                        ...
                        $('td:last-child', nRow).html(''
                            ...
                            '" target="blank" class="btn btn-sm btn-primary"  data-toggle="tooltip" data-placement="left" title="พิมพ์ใบเสร็จทั้งหมด" ><i class="bx bx-printer grow " style="font-size:14px;cursor:pointer;color:white;margin-top:1px;"></i></a> ' +
                            '<a href="{{ url('backend/pick_warehouse') }}/' + aData['id'] +
                            '/cancel?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="ดูข้อมูลการจ่ายแต่ละครั้ง" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                        ...
                        $('td:last-child', nRow).html(''
                            ...
                            +
                            '<a href="{{ url('backend/pick_warehouse') }}/' + aData['id'] +
                            '/cancel?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="ยกเลิก" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                ...
                $(function() {
                    ...
                    oTable = $('#data-table-packing').DataTable({
                        ...
                        rowCallback: function(nRow, aData, dataIndex) {
                            ...
                            //        + '<a href="{{ url('backend/pick_warehouse') }}?id='+aData['id']+'&remain=1" class="btn btn-sm btn-primary"  data-toggle="tooltip" data-placement="left" title="อนุมัติเบิกจากคลัง" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '

                            //       + '<a href="javascript:void(0);" class="btn btn-sm" data-toggle="tooltip" data-toggle="tooltip" data-placement="left" title="ต้องอนุมัติก่อน" disabled style="background-color:grey;color:white;" >จัดส่ง</a> '

                            //         + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/edit?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="แก้ไขใบเบิก" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                            ...
                            //        + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/edit?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="แก้ไขใบเบิก/ยกเลิก" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '

                            //       + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/qr?remain=1" class="btn btn-sm btn-info" data-toggle="tooltip" data-toggle="tooltip" data-placement="left" title="Scan QR-Code / จัดส่ง" >จัดส่ง</a> '
                            ...
                            //        + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/cancel?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="ยกเลิก" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                            ...
                            //        + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/cancel?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="ดูข้อมูล" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
