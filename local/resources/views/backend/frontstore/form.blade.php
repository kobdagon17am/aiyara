    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-flex align-items-center justify-content-between">
                <h4 class="mb-0 font-size-18  "> จำหน่ายสินค้าหน้าร้าน > เปิดรายการขาย
                    ({{ \Auth::user()->position_level == 1 ? 'Supervisor/Manager' : 'CS' }}) </h4>
                    ...
                    <div class="myBorder" style="background-color: white;">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if (@$sRow->distribution_channel_id_fk == 3)
                                            ...
                                            <select id="distribution_channel_id_fk"
                                        ...
                                        @else
                                            ...
                                            <select id="distribution_channel_id_fk" name="distribution_channel_id_fk"
                                                class="form-control select2-templating ch_Disabled " required>
                                                <option value="">Select</option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($ChangePurchaseType == 1)
                                            <input type="hidden" class="agency" name="agency"
                                                value="{{ @$sRow->agency }}">
                                            @if (@$sRow->agency !== '')
                                                <select {{ @$disChannel3 }} id="agency"
                                        ...
                                        @else
                                            <input type="hidden" class="agency" name="agency"
                                                value="{{ @$sRow->agency }}">
                                            <select id="agency" class="form-control select2-templating ch_Disabled "
                                                disabled>
                                                <option selected>
                                                    {{ @$CusAgencyName }}
                                                </option>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        @if ($ChangePurchaseType == 1)
                                            <input type="hidden" class="aistockist" name="aistockist"
                                                value="{{ @$sRow->aistockist }}">
                                            @if (@$sRow->aistockist !== '')
                                                <select {{ @$disChannel3 }} id="aistockist"
                                                    class="form-control select2-templating ch_Disabled ">
                                                    <option selected>
                                                        {{ @$CusAistockistName }}
                                                    </option>
                                        ...
                                        @else
                                            <input type="hidden" class="aistockist" name="aistockist"
                                                value="{{ @$sRow->aistockist }}">
                                            <select id="aistockist" class="form-control select2-templating ch_Disabled "
                                                disabled>
                                                <option selected>
                                                    {{ @$CusAistockistName }}
                                                </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group row">
                                    <label for="customers_id_fk_name" class="col-md-4 col-form-label"> ชื่อ-นามสกุลลูกค้า
                                        (กรณีไม่ทราบรหัส) : </label>
                                    <div class="col-md-7">


                                        @if (!empty(@$sRow->customers_id_fk))
                                            <input type="hidden" name="customers_id_fk_name"
                                                value="{{ $sRow->customers_id_fk }}">
                                            <input type="text" class="form-control" value="{{ @$CusName }}"
                                                disabled="">
                                        @else
                                            <select id="customers_id_fk_name" name="customers_id_fk_name"
                                                class="form-control">
                                            </select>
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        @if ($ChangePurchaseType == 1)
                                            ...
                                            @if (@$sRow->purchase_type_id_fk == 5)
                                                <input type="hidden" id="purchase_type_id_fk" name="purchase_type_id_fk"
                                            ...
                                            @ELSE
                                                ...
                                                <select {{ @$disChannel3 }} id="purchase_type_id_fk"
                                                    name="purchase_type_id_fk"
                                                    class="form-control select2-templating ch_Disabled "
                                                    <?= $disAiStockist ?> required>
                                                    <option value="">Select</option>
                                                    @if (@$sPurchase_type)
                            ...
                            @if (!empty(@$sRow->purchase_type_id_fk) and $sRow->status_run_pv != 'success')
                                ...
                                @ELSE
                                    <div class="col-md-11 text-right div_btnSaveChangePurchaseType">
                                        <br>
                                        <button type="button"
                                            class="btn btn-primary btn-sm waves-effect font-size-14 btnSaveChangePurchaseType ch_Disabled ">
 ...
 ?>
                        <div class="row">
                            <div class="col-12">
                                        ...
                                        @ELSE
                                            ...
                                            @ELSE
                                                ...
                                                <a class="btn btn-success btn-aigreen btn-sm mt-1 btnAddFromPromotion "
                                                    href="#">
                                                    <i class="bx bx-plus align-middle mr-1 font-size-18"></i><span
                                                        style="font-size: 14px;">เพิ่มจากรหัสโปรโมชั่น</span>
                                                </a>
                                                <a class="btn btn-success btn-aigreen btn-sm mt-1 btnAddFromProdutcsList "
                                                    href="#">
                                                    <i class="bx bx-plus align-middle mr-1 font-size-18"></i><span
                                                        ...
                                                        <table class="table">
                                                            <tr class="table-success">
                                                                <td><strong>{{ $check_giveaway_value['rs']['name'] }} x
                                                                        [{{ $check_giveaway_value['rs']['count_free'] }}]</strong>
                                                                </td>
                                                            ...
                                                            @else
                                                                {{-- GiftVoucher --}}
                                                                <tr>
                                                                    <td><strong style="font-size: 12px">GiftVoucher
                                                                            {{ $check_giveaway_value['rs']['gv'] }} x
                                                                            [{{ $check_giveaway_value['rs']['count_free'] }}]</strong>
                                                                    </td>
                                                                    <?php $gv_total = $check_giveaway_value['rs']['gv'] * $check_giveaway_value['rs']['count_free']; ?>
                                                                    <td align="right"><strong>
                                                                            {{ number_format($gv_total) }} GV</strong>
                                                                    </td>
                                                                </tr>
                                                            @endif
                                                        </table>
                                ...
                                <div class="form-group row" style="display: none;">
                                    ...
                                    <div class="col-md-2">
                                        <input class="form-control" id="sum_price_desc" name="sum_price_desc"
                                            value="{{ @$sFrontstoreDataTotal[0]->total }}" readonly=""
                                            style="text-align: center;font-size: 16px;color: red;font-weight: bold;" />
                                    </div>
                                </div>
                                                    ...
                                                    <table class="table table-striped mb-0">
                                                        ...
                                                        <thead <?= @$dis_addr ?>>
                                                            <tr style="background-color: #f2f2f2;">
                                                                ...
                                                                <input type="hidden" class="ShippingCalculate02"
                                                                    province_id="{{ @$sRow->delivery_province_id }}"
                                                                    id="delivery_province_id"
                                                                    value="{{ @$sRow->delivery_province_id }}">
                                                            </tr>
                                                        </thead>
                                                        <tbody <?= @$dis_addr ?>>

                                                            <tr>
                                                                <th scope="row" class="bg_addr d-flex"
                                                                    style="<?= $bg_04 ?>">
                                                                    ...
                                                                    @if (@$sRow->shipping_special == 1)
                                                                        ...
                                                                        <div class="col-md-6">
                                                                            <select {{ @$disChannel3 }}
                                                                                {{ @$pay_type_transfer_aicash }} disabled
                                                                                id="sentto_branch_id"
                                                                                name="sentto_branch_id"
                                                                                class="form-control select2-templating ShippingCalculate "
                                                                                {{ @$dis_addr }}>
                                                                                @if (@$sBranchs)
                                                                                    @foreach (@$sBranchs as $r)
                                                                                        @if (@$sRow->sentto_branch_id > 0)
                                                                                            ...
                                                                                            <option
                                                                                                value="{{ $r->id }}"
                                                                                                {{ @$r->id == @$sRow->sentto_branch_id ? 'selected' : '' }}>
                                                                                                {{ $r->b_name }}
                                                                                            </option>
                                                            ...
                                                            <tr>
                                                                <th scope="row" style="">
                                                                    <input {{ @$disChannel3 }}
                                                                        ...
                                                                        {{ @$shipping_special[0]->shipping_name }}
                                                                    </label>
                                                                    <input type="hidden" name="shipping_special_cost"
    ...
    @ENDIF -->
                                                ...
                                                <div class="row">
                                                    <div class="">
                                                            ...
                                                            <div class="divTableBody">
                                                                ...
                                                                <div class="divTableRow">
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        ...
                                                                        <input
                                                                            class="form-control f-ainumber-18 input-aireadonly "
                                                                            id="pv_total" name="pv_total"
                                                                            value="{{ @$sRow->pv_total > 0 ? number_format(@$sRow->pv_total, 2) : '0.00' }}"
                                                                            readonly="" />
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                    </div>
                                                                ...
                                                                <div class="divTableRow">
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        ...
                                                                        <input
                                                                            class="form-control f-ainumber-18 input-aireadonly "
                                                                            id="sum_price" name="sum_price"
                                                                            value="{{ @$sRow->sum_price > 0 ? number_format(@$sRow->sum_price, 2) : '' }}"
                                                                            readonly="" />
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                    </div>
                                                                ...
                                                                <div class="divTableRow">
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        <input id="product_value" name="product_value"
                                                                            class="form-control f-ainumber-18 input-aireadonly"
                                                                ...
                                                                <div class="divTableRow">
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        <input id="tax" name="tax"
                                                                            class="form-control f-ainumber-18 input-aireadonly"
                                                                            value="{{ @$sRow->tax > 0 ? number_format(@$sRow->tax, 2) : '' }}"
                                                                            readonly="" />
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                    </div>
                                                                ...
                                                                @if (@$sRow->purchase_type_id_fk != 6)
                                                                    <div class="divTableRow ">
                                                                        ...
                                                                        <div class="divTableCell" style='z-index: 1'>
                                                                            <input
                                                                                class="form-control f-ainumber-18 input-aireadonly input_shipping_free "
                                                                                value="(ค่าจัดส่งฟรี)" readonly
                                                                                style="display: none;" />
                                                                            <input
                                                                                class="form-control f-ainumber-18 input-aireadonly input_shipping_nofree "
                                                                                id="shipping_price" name="shipping_price"
                                                                                value="{{ @$sRow->shipping_price > 0 ? number_format(@$sRow->shipping_price, 2) : '0.00' }}"
                                                                                readonly />
                                                                        </div>
                                                                        <div class="divTableCell">
                                                                        </div>
                                                        ...
                                                        =================================== -->
                                                                        ...
                                                                        ?>
                                                                        <input type="hidden"
                                                                            name="<?= $disAfterSave == 'disabled' ? 'pay_type_id_fk' : '' ?>"
                                                                            value="{{ @$sRow->pay_type_id_fk }}">

                                                                        <select {{ @$disChannel3 }} id="pay_type_id_fk"
                                                                            name="pay_type_id_fk"
                                                                            class="form-control select2-templating ch_Disabled "
                                                                            {{ @$disAfterSave }} required>
                                                                            <option value="">Select</option>
                                                                            @if (@$sPay_type)
                                                                ...
                                                                <div class="divTableRow div_fee " style="<?= $div_fee ?>">
                                                                    ...
                                                                    <div class="divTableCell div_charger_type "
                                                                        ...
                                                                        <input {{ @$disAfterSave }} type="radio"
                                                                            ...
                                                                            name="charger_type" value="2"
                                                                            <?= @$sRow->charger_type == 2 ? 'checked' : '' ?>>
                                                                        <label for="charger_type_02">&nbsp;&nbsp;แยกชำระ
                                                                        </label>
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                    </div>
                                                                ...
                                                                <div class="divTableRow show_div_credit "
                                                                    style="<?= $show_div_credit ?>">
                                                                    <div class="divTableCell"> </div>
                                                                    <div class="divTH">
                                                                        <label for="" class="">
                                                                            ยอดชำระเงินด้วยบัตรเครดิต : </label>
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                        <input {{ @$disAfterSave }}
                                                                            class="form-control CalPrice NumberOnly input-airight f-ainumber-18 input-aifill in-tx ch_Disabled "
                                                                            id="credit_price" name="credit_price"
                                                                            placeholder=""
                                                                            value="{{ number_format(@$sRow->credit_price, 2) }}"
                                                                            required="" />
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="divTableRow show_div_credit "
                                                                    ...
                                                                    <div class="divTH">
                                                                        <label for="" class="">
                                                                            ค่าธรรมเนียมบัตร : </label>
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                        <input {{ @$disAfterSave }}
                                                                            class="form-control f-ainumber-18 input-aireadonly ch_Disabled "
                                                                            id="fee_amt" name="fee_amt"
                                                                            value="{{ number_format(@$sRow->fee_amt, 2) }}"
                                                                            readonly />
                                                                    </div>
                                                                ...
                                                                <div class="divTableRow show_div_credit "
                                                                    ...
                                                                    <div class="divTH">
                                                                        <label for="" class="">
                                                                            หักจากบัตรเครดิต : </label>
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                        <input {{ @$disAfterSave }}
                                                                            class="form-control f-ainumber-18-b input-aireadonly ch_Disabled "
                                                                            id="sum_credit_price" name="sum_credit_price"
                                                                            value="{{ number_format(@$sRow->sum_credit_price, 2) }}"
                                                                            readonly />
                                                                    </div>
                                                                        ...
                                                                        @if (@$sAccount_bank)
                                                                            @foreach (@$sAccount_bank as $r)
                                                                                <input
                                                                                    ...
                                                                                    value="{{ @$r->id }}"
                                                                                    <?= @$r->id == @$sRow->account_bank_id ? 'checked' : '' ?>>
                                                                                <label
                                                                                    for="account_bank_id{{ @$r->id }}">&nbsp;&nbsp;{{ @$r->txt_account_name }}
                                                                                    {{ @$r->txt_bank_name }}
                                                                                    {{ @$r->txt_bank_number }}</label><br>
                                                                            @endforeach
                                                                        @endif
                                                                ...
                                                                <div class="divTableRow div_pay_with_other_bill "
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        ...
                                                                        <select id="pay_with_other_bill_note"
                                                                            ...
                                                                            <option selected
                                                                                value="{{ @$sRow->pay_with_other_bill_note }}">
                                                                                {{ @$sRow->pay_with_other_bill_note }}
                                                                            </option>
                                                                            {{-- @foreach (@$r_invoice_code as $r)
                                                                                    <option value="{{ $r->code_order }}"
                                                                                        <?php
                                                                                        //  if ($r->code_order == @$sRow->pay_with_other_bill_note) {
                                                                                        //     echo 'selected';
                                                                                        // }
                                                                                        ?>
                                                                                        >
                                                                ...
                                                                <div class="divTableRow show_div_transfer_price "
                                                                    ...
                                                                    <div class="divTableCell">
                                                                        ...
                                                                        @if (@$sRow->pay_type_id_fk == 8)
                                                                            <input
                                                                                class="form-control input-airight f-ainumber-18-b input-aireadonly  class_transfer_edit ch_Disabled "
                                                                                id="transfer_price" name="transfer_price"
                                                                                value="{{ number_format(@$sRow->transfer_price, 2) }}">
                                                                        @ELSE
                                                                            <input
                                                                                class="form-control CalPrice input-airight f-ainumber-18-b input-aifill class_transfer_edit NumberOnly ch_Disabled "
                                                                                id="transfer_price" name="transfer_price"
                                                                                value="{{ number_format(@$sRow->transfer_price, 2) }}">
                                                                        @ENDIF
                                                                ...
                                                                <div class="divTableRow show_div_aicash_price "
                                                                    ...
                                                                    <div class="divTableCell"></div>
                                                                    <div class="divTH">
                                                                        <label for="aicash_price" class="">
                                                                            ระบุรหัสสมาชิก Ai-cash : </label>
                                                                    </div>
                                                                    <div class="divTableCell">
                                                                        ...
                                                                        @if (!empty(@$sRow->member_id_aicash))
                                                                            <input type="hidden" class="form-control"
                                                                                ...
                                                                                id="member_id_aicash"
                                                                                value="{{ @$sRow->member_id_aicash }}">
                                                                            <input type="hidden" class="form-control"
                                                                                name="member_name_aicash"
                                                                                id="member_name_aicash"
                                                                                value="{{ @$Customer_name_Aicash }}">
                                                                        ...
                                                                        @else
                                                                            ...
                                                                            <input type="hidden" name="member_id_aicash"
                                                                                id="member_id_aicash">

                                                                            <select id="aicash_choose"
                                                                                class="form-control ch_Disabled ">
                                                                                <option value="">-Select-</option>
                                                                            </select>
                                                                        @endif

                                                                        <select id="member_id_aicash_select"
                                                                            name="member_id_aicash_select"
                                                                            class="form-control ch_Disabled "></select>
                                                                    ...
                                                                    @if (!empty(@$sRow->pay_type_id_fk))
                                                                        ...
                                                                        <div class="divTableCell">
                                                                            <input
                                                                                class="form-control f-ainumber-18 input-aireadonly  "
                                                                                value="{{ @$Cus_Aicash }}"
                                                                                id="aicash_remain" readonly="">
                                                                        </div>

                                                                        <div class="divTableCell">


                                                                            <button {{ @$disAfterSave }} type="button"
                                                                                class="btn btn-primary font-size-14 btnCalAddAicash ch_Disabled "
                                                                                style="padding: 3px;">ดำเนินการ</button>
                                                            ...
                                                            @ELSE
                                                                ...
                                                                <div class="divTableCell">
                                                                    <input {{ @$disAfterSave }}
                                                                        class="form-control f-ainumber-18 input-aireadonly  ch_Disabled "
                                                                        name="aicash_remain" id="aicash_remain"
                                                                        value="{{ @$Cus_Aicash }}" readonly="">
                                                                </div>
                                                            ...
                                                            <div class="divTableRow show_div_cash_price "
                                                                style="display: none;">
                                                                <div class="divTableCell"></div>
                                                                <div class="divTH">
                                                                    <label for="cash_price" class="">
                                                                        cash_price : </label>
                                                                </div>
                                                                <div class="divTableCell">
                                                                    <input
                                                                        class="form-control input-airight f-ainumber-18 ch_Disabled "
                                                                        id="cash_price" name="cash_price"
                                                                        value="{{ number_format(@$sRow->cash_price, 2) }}"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="divTableRow show_div_cash_pay "
                                                                ...
                                                                <div class="divTH">
                                                                    <label for=""
                                                                        class="label_cash_pay">ยอดเงินสดที่ต้องชำระ :
                                                                    </label>
                                                                </div>
                                                                <div class="divTableCell">
                                                                    <?php
                          ...
                          // echo @$gift_voucher; ห
                              if(@$gift_voucher>0){
                                ...
                                ?>
                                                                    ...
                                                                    <input
                                                                        class="form-control f-ainumber-18  in-tx ch_Disabled  text-right"
                                                                        name="cash_pay" id="cash_pay"
                                                                        value="{{ number_format(@$cash_pay, 2) }}">
                                                                    <?php
                              }else{
                                ...
                                ?>
                                                                    {{-- วุฒิเอาออก readonly=""  และ class input-aireadonly --}}
                                                                    <input
                                                                        class="form-control f-ainumber-18-b  in-tx ch_Disabled text-right"
                                                                        name="cash_pay" id="cash_pay"
                                                                        value="{{ number_format(@$cash_pay, 2) }}">
                                                                    <?php
                              }
                    ...
                    ?>
                                                                        ...
                                                                        <input type="hidden"
                                                                            id="pay_type_transfer_slip"
                                                                            name="pay_type_transfer_slip"
                                                                            value="1">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddFromPromotionTitle"><b><i
                                class="bx bx-play"></i>รายการรหัสโปรโมชั่น</b></h5>
                ...
                <form id="frmAddPro" action="{{ route('backend.frontstorelist.store') }}" method="POST"
                    enctype="multipart/form-data" autocomplete="off">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="page-title-box d-flex">
                                            ...
                                            <input class="col-4 form-control " type="text" name="txtSearchPro"
                                                id="txtSearchPro"> &nbsp; &nbsp;
                                            <button class="btn btn-success btnCheckProCode ">ตรวจสอบ</button>

                                        </div>

                                        <div class=" note_coupon_inactive "
                                            style="color: red;font-size: 16px;margin-left: 5%;">
                                        </div>

                                        <div class="modal-title">
                                            <input id="pro_name" type="text" readonly=""
                                        ...
                                        <div class="form-group row show_add_coupon " style="display: none;">
                                            <label for="tracking_type" class="col-md-5 col-form-label"> จำนวน (ชุด) :
                                            </label>
                                            <div class="col-md-7">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary btnSavePro " style="display: none;"><i
    ...
    <div class="modal fade" id="modalAddFromProductsList" tabindex="-1" role="dialog"
        aria-labelledby="modalAddFromProductsListTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddFromProductsListTitle"><b><i
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class=" d-flex ">
                                        <button class="btn btn-success btnProductAll1 " data-value="1"
                                            style="margin-right: 1%;">ทั้งหมด</button>
                                        <button class="btn btn-success btnAihealth2 " data-value="2"
                                            style="margin-right: 1%;">AiHealth</button>
                                        <button class="btn btn-success btnAilada3 " data-value="3"
                                            style="margin-right: 1%;">AiLADA</button>
                                        <button class="btn btn-success btnAibody4 " data-value="4"
                                            style="margin-right: 1%;">AiBODY</button>
                                        <button class="btn btn-success btnAihouse " data-value="5"
                                            style="margin-right: 1%;">AIhouse</button>
                                        <button class="btn btn-success btnPromotion8 " data-value="8"
                                            style="margin-right: 1%;">Promotion</button>
                                    </div>

                                    <form class="frmFrontstorelist" id="frmFrontstorelist"
                                    ...
                                    <form class="frmFrontstorelistPro"
                                        action="{{ route('backend.frontstorelist.store') }}" method="POST"
                                        enctype="multipart/form-data" autocomplete="off">
                                        <input name="frontstore_id" type="hidden" value="{{ @$sRow->id }}">
                                        <input name="branch_id_fk" type="hidden"
                                        ...
                                        <div class="form-group row div-data-table-list-pro " style="display: none;">
                                            <div class="col-md-12">
                                                @if (@$sRow->id)
                                                    <table id="data-table-list-pro" class="table table-bordered "
                ...
                <div class="modal-body">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="delivery_cusname" class="form-control"
                                    value="{{ @$CusAddrFrontstore[0]->recipient_name }}" required>
                            </div>
                        </div>
                                ...
                                <select id="delivery_province" name="delivery_province"
                                    ...
                                    @if (@$sProvince)
                                        @foreach (@$sProvince as $r)
                                            <option value="{{ $r->id }}"
                                                {{ @$r->id == @$CusAddrFrontstore[0]->province_id_fk ? 'selected' : '' }}>
                                                {{ $r->province_name }}
                                            </option>
                                        @endforeach
                                    @endif
                                    ...
                                    @if (@$CusAddrFrontstore[0]->amphur_code)
                                        ...
                                        @if (@$sAmphures)
                                            @foreach (@$sAmphures as $r)
                                                <option value="{{ $r->id }}"
                                                    {{ @$r->id == @$CusAddrFrontstore[0]->amphur_code ? 'selected' : '' }}>
                                                    {{ $r->amphur_name }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    @if (@$CusAddrFrontstore[0]->tambon_code)
                                        ...
                                        @if (@$sTambons)
                                            @foreach (@$sTambons as $r)
                                                <option value="{{ $r->id }}"
                                                    {{ @$r->id == @$CusAddrFrontstore[0]->tambon_code ? 'selected' : '' }}>
                                                    {{ $r->tambon_name }}
                                                </option>
                                            @endforeach
                                        @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="delivery_tel" class="form-control"
                                    value="{{ @$CusAddrFrontstore[0]->tel }}" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="text" name="delivery_tel_home" class="form-control"
                                    value="{{ @$CusAddrFrontstore[0]->tel_home }}">
                            </div>
                        </div>
    ...
    <div class="modal fade" id="modalAddList" tabindex="-1" role="dialog" aria-labelledby="modalAddListTitle"
        aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document" style="max-width: 50% !important;">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="modalAddListTitle"><b><i class="bx bx-play"></i>เพิ่มรายการย่อย</b>
                    </h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                        ...
                        <form id="frmFrontstoreAddList" action="{{ url('backend/frontstorelist/plus') }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <select name="product_id_fk[]" id="product_id_fk"
                                        class="form-control select2-templating ">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <input type="number" name="quantity[]" id="amt" min="1"
    ...
    <div id="modalAddAiCash" tabindex="-1" role="dialog" aria-labelledby="modalAddAiCash" aria-hidden="true"
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg " role="document">
            <div class="modal-content">
                ...
                <form id="frmAddAiCash" action="{{ route('backend.frontstorelist.store') }}" method="POST"
                    enctype="multipart/form-data" autocomplete="off">
                    <!-- <input name="frontstore_id" type="hidden" value="{{ @$sRow->id }}"> -->
    ...
    <div class="modal fade" id="modalCourse" tabindex="-1" role="dialog" aria-labelledby="modalCourseTitle"
        aria-hidden="true">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 text-right  ">
                                <button type="submit" class="btn btn-primary btnSaveCourse "
                                    style="width: 8%;">Save</button>
                                <button type="button" class="btn btn-secondary" data-dismiss="modal"
                                    style="margin-left: 2px;">Close</button>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade" id="cancel" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            <div class="modal-content">
                ...
                <form action="{{ route('backend.frontstore.store') }}" method="POST" enctype="multipart/form-data"
                    autocomplete="off">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="file" accept="image/*" id="image01" name="image01" class="form-control"
                            OnChange="showPreview_01(this)" required="">
                        <center>
...
@section('script')
            ...
            oTable = $('#data-table-list').DataTable({
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['check_press_save'] == "2" && r_approve_status != "6") {
                        ...
                        $('td:last-child', nRow).html('' +
                            '<a href="javascript: void(0);" data-url="{{ route('backend.frontstorelist.index') }}/' +
                            aData['id'] + '" data-id="' + aData['id'] + '"  frontstore_id_fk="' +
            ...
            $('#data-table-list-pro').DataTable({
                    ...
                    },
                    {
                        ...
                        render: function(d) {
                            ...
                            if (d) {
                                ...
                                return '<input name="promotion_id_fk_pro[]" value="' + v[0] +
                                    '" type="hidden" ><div class="input-group inline-group"> ' +
                                    ' <div class="input-group-prepend"> ' +
                                    '   <button promotion_id_fk="' + v[0] +
                                    '" limited_amt_person="' + v[1] +
                                    '" class="btn btn-outline-secondary btn-minus-product-pro "> ' +
                                    '     <i class="fa fa-minus"></i> ' +
                                    '   </button>' +
                                    ...
                                    '   <button promotion_id_fk="' + v[0] +
                                    '" limited_amt_person="' + v[1] +
                                    '" class="btn btn-outline-secondary btn-plus-product-pro "> ' +
                                    '     <i class="fa fa-plus"></i> ' +
                                    '    </button> ' +
                                    '  </div> ' +
                                    ' </div> ';
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['frontstore_promotions_list'] > 0) {
                        ...
                        $("td:eq(4)", nRow).html(
                            '<input name="promotion_id_fk_pro[]" value="' + aData[
                                'frontstore_promotions_list'] +
                            '" type="hidden" ><div class="input-group inline-group"> ' +
                            ' <div class="input-group-prepend"> ' +
                            '   <button promotion_id_fk="' + aData['frontstore_promotions_list'] +
                            '" limited_amt_person="' + aData['limited_amt_person'] +
                            '" class="btn btn-outline-secondary btn-minus-product-pro "> ' +
                            '     <i class="fa fa-minus"></i> ' +
                            '   </button>' +
                            '   <input class=" quantity xxx " min="0" name="quantity[]" value="' +
                            aData['frontstore_promotions_list'] + '" type="number"  >' +
                            '   <div class="input-group-append"> ' +
                            '   <button promotion_id_fk="' + aData['frontstore_promotions_list'] +
                            '" limited_amt_person="' + aData['limited_amt_person'] +
                            '" class="btn btn-outline-secondary btn-plus-product-pro "> ' +
    ...
    <script type="text/javascript">
                    ...
                    oTable = $('#data-table-products-list').DataTable({
                        ...
                        columns: [{
                            ...
                            },
                            {
                                ...
                                render: function(d) {
                                    ...
                                    return '<input name="product_id_fk[]" value="' +
                                        d +
                                        '" type="hidden" ><div class="input-group inline-group"> ' +
                                        ' <div class="input-group-prepend"> ' +
                                        '   <button data-product_id_fk="' + d +
                        ...
                        rowCallback: function(nRow, aData, dataIndex) {
                            ...
                            if (aData['frontstore_products_list'] > 0) {
                                ...
                                $("td:eq(4)", nRow).html(
                                    '<input name="product_id_fk[]" value="' + aData[
                                        'id'] +
                                    '" type="hidden" ><div class="input-group inline-group"> ' +
                                    ' <div class="input-group-prepend"> ' +
                                    ...
                                    '   </button>' +
                                    '   <input class=" quantity xxx " min="0" name="quantity[]" value="' +
                                    aData['frontstore_products_list'] +
                                    '" type="number"  >' +
                                    '   <div class="input-group-append"> ' +
                                    '   <button data-product_id_fk="' + aData[
                                        'id'] +
                                    '" class="btn btn-outline-secondary btn-plus"> ' +
                                    '     <i class="fa fa-plus"></i> ' +
                                    '    </button> ' +
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.btn-plus-product-pro, .btn-minus-product-pro', function(e) {
                ...
                const isNegative = $(e.target).closest('.btn-minus-product-pro').is(
                    '.btn-minus-product-pro');
                            ...
                            $(function() {
                                ...
                                oTable = $('#data-table-list').DataTable({
                                    ...
                                    columns: [{
                                        ...
                                        {
                                            data: 'product_name',
                                            title: '<center>ชื่อสินค้า/บริการ</center>',
                                            className: 'text-left',
                                            render: function(d) {
                                                return d;
                                            }
                                    ...
                                    rowCallback: function(nRow, aData,
                                        ...
                                        var info = $(this).DataTable().page
                                            .info();
                                        $("td:eq(0)", nRow).html(info
                                            .start + dataIndex + 1);
        ...
        $(document).ready(function() {
            $(document).on('click',
                '.btnProductAll1,.btnAihealth2,.btnAilada3,.btnAibody4,.btnPromotion8,.btnAihouse',
                function(event) {
                            ...
                            },
                            {
                                ...
                                render: function(d) {
                                    ...
                                    if (d) {
                                        ...
                                        return '<input name="promotion_id_fk_pro[]" value="' +
                                            v[0] +
                                            '" type="hidden" ><div class="input-group inline-group"> ' +
                                            ' <div class="input-group-prepend"> ' +
                                            '   <button promotion_id_fk="' + v[0] +
        ...
        $(document).ready(function() {
            $(document).on('click', '.btnCheckProCode', function(event) {
                ...
                var customers_id_fk = $("input[name='customers_id_fk']")
                    .val(); //alert(purchase_type_id_fk);
                    ...
                    success: function(msg) {
                                    ...
                                    oTable2 = $(
                                        ...
                                        .DataTable({
                                            ...
                                            columns: [{
                                                ...
                                                {
                                                    data: 'currency',
                                                    title: '<center>สกุลเงิน</center>',
                                                    className: 'text-center'
                                                },
                                                {
                                                    data: 'cost_price',
                                                    title: '<center>ราคาทุน</center>',
                                                    className: 'text-center'
                                                },
                                                {
                                                    data: 'selling_price',
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                //  console.log(data);
                                $.each(data, function(key, value) {
                                    $("#pro_name").val("ชื่อโปร : " + value
                                        .pro_name);
                                    $("#limited_amt_person").val(value
                                        .limited_amt_person);
                                    $(".plus-pro").attr('max', value
                                        .limited_amt_person);
                                });
    ...
    <script type="text/javascript">
                    ...
                    $.ajax({
                        ...
                        success: function(d) {
                            ...
                            if (d) {
                                ...
                                if (pay_type_id_fk == 5) {
                                    $("#aicash_price").val(formatNumber(parseFloat(0)
                                        .toFixed(2)));
                                }
                                ...
                                $.each(d, function(key, value) {
                                    ...
                                    $("#pv_total").val(formatNumber(parseFloat(
                                        value.pv_total).toFixed(2)));
                                    $("#sum_price").val(formatNumber(parseFloat(
                                        value.sum_price).toFixed(2)));
                                    $("#product_value").val(formatNumber(
                                        parseFloat(value.product_value)
                                        .toFixed(2)));
                                    $("#tax").val(formatNumber(parseFloat(value
                                        .tax).toFixed(2)));

                                    $("#credit_price").val(formatNumber(
                                        parseFloat(value.credit_price)
                                        .toFixed(2)));
                                    $("#fee_amt").val(formatNumber(parseFloat(
                                        value.fee_amt).toFixed(2)));
                                    $("#sum_credit_price").val(formatNumber(
                                        parseFloat(value
                                            .sum_credit_price).toFixed(
                                            2)));

                                    $("#transfer_price").val(formatNumber(
                                        parseFloat(value.transfer_price)
                                        .toFixed(2)));

                                    $("#cash_price").val(formatNumber(
                                        parseFloat(value.cash_price)
                                        .toFixed(2)));

                                    if (pay_type_id_fk == '') {
                                        $("#cash_pay").val('');
                                    } else {
                                        $("#cash_pay").val(formatNumber(
                                            parseFloat(value.cash_pay)
                                            .toFixed(2)));
                                    }
                                    ...
                                    if (value.shipping_free == 1) {
                                        ...
                                        $('#shipping_price').val(formatNumber(
                                            parseFloat(value
                                                .shipping_price)
                                            .toFixed(2)));
        ...
        $(document).ready(function() {
            ...
            $('.ShippingCalculate_deli').on('click change', function(e) {

                var v = $(this).val();
                if ("{{ @$sRow->delivery_location }}" == '0') {
                    var frontstore_id_fk = "{{ @$sRow->id }}";
                    var bill_transfer_other = $('#bill_transfer_other').val();

                    Swal.fire({
                        type: "info",
                        title: "คุณต้องการบันทึกเปลี่ยนแปลงหรือไม่?",
                        // showDenyButton: true,
                        showCancelButton: true,
                        confirmButtonText: "ยืนยัน",
                        cancelButtonText: "ยกเลิก",
                        // denyButtonText: "สินสุด",
                    }).then((result) => {
                        console.log(result);
                        /* Read more about isConfirmed, isDenied below */
                        if (result.value == true) {
                            $.ajax({
                                url: " {{ url('backend/frontstore_save_delivery_location') }} ",
                                method: "post",
                                data: {
                                    "_token": "{{ csrf_token() }}",
                                    frontstore_id_fk: frontstore_id_fk,
                                    delivery_location: v,
                                    bill_transfer_other: bill_transfer_other,
                                },
                                success: function(data) {
                                    if (data['status'] == 1) {
                                        Swal.fire({
    ...
    <script type="text/javascript">
        ...
        function fnShippingCalculate($province_id) {
            ...
            $.ajax({
                ...
                data: $("#frm-main").serialize() + "&province_id=" + $province_id + "&pay_type_id_fk=" +
                    pay_type_id_fk,
                success: function(data) {
                    console.log(data);
                    // return false;
    ...
    <script type="text/javascript">
            ...
            $(document).on('change', '#pay_type_id_fk', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // return false;
                        $.each(data, function(key, value) {
                            $("#aicash_price").val(formatNumber(parseFloat(value
                                .aicash_price).toFixed(2)));
                            $("#cash_price").val(formatNumber(parseFloat(value
                                .cash_price).toFixed(2)));
                            ...
                            if (pay_type_id_fk == 7) {
                                ...
                                if (pay_type_id_fk == 2) {
                                    ...
                                    if (pay_type_id_fk == 8) {
                                        ...
                                        $("#transfer_price").removeClass('input-aifill')
                                            .addClass('input-aireadonly');
                                        ...
                                        if (pay_type_id_fk == 9) {
                                            ...
                                            $('#fee').val("").select2();
                                            $('#fee').attr('required', true);
                                            $('#charger_type:first-child').attr('checked',
                                                true);

                                            // Ai-Cash
                                            $(".show_div_aicash_price").show();
                                            $("#aicash_price").removeClass('input-aifill')
                                                .addClass('input-aireadonly');
                                            $("#aicash_price").val('');
                                            ...
                                            $('input[name=account_bank_id]').removeAttr(
                                                'required');
                                            ...
                                            if (pay_type_id_fk == 10) {
                                                ...
                                                if (pay_type_id_fk == 11) {
                                                    ...
                                                    // Ai-Cash
                                                    $(".show_div_aicash_price").show();
                                                    $("#aicash_price").removeClass(
                                                        'input-aifill').addClass(
                                                        'input-aireadonly');
                                                    $("#aicash_price").val('');
                                                    $("#aicash_price").attr('readonly', true);
                                                    ...
                                                    $('#member_id_aicash').attr('required',
                                                        true);
                                                    ...
                                                    if (pay_type_id_fk == 4) {
                                                        ...
                                                        if (pay_type_id_fk == 12) {
                                                            ...
                                                            $(".show_div_transfer_price")
                                                                .show();
                                                            // $('input[name=account_bank_id]').prop('checked',false);
                                                            $('input[name=account_bank_id]')
                                                                .attr('required', true);
                                                            $(".div_account_bank_id").show();
                                                            $(".div_pay_with_other_bill")
                                                                .show();
                                                            $("#transfer_price").val('');
                                                            // $(".transfer_money_datetime").attr('required', true);
                                                            $("#transfer_price").attr(
                                                            ...
                                                            $("#transfer_price").removeClass(
                                                                    'input-aireadonly')
                                                                .addClass('input-aifill')
                                                                .addClass('CalPrice');

                                                            // $(".show_div_cash_pay").show();
                                                            $('#fee').removeAttr('required');
                                                            $('#aicash_price').removeAttr(
                                                                'required');
                                                            $("#cash_pay").val('');
        ...
        $(document).on('change', '.CalPrice', function(event) {
            ...
            if (pay_type_id_fk == 1 || pay_type_id_fk == 10 || pay_type_id_fk == 11 || pay_type_id_fk == 12) {
                ...
                if (transfer_price <= 0) {
                    alert(
                        "! กรอกข้อมูลไม่ถูกต้อง เนื่องจากได้เลือกประเภทการชำระเงิน โอนชำระ ยอดโอนควรมากกว่าศูนย์"
                    );
                    $("#cash_pay").val(0);
                    $("#cash_price").val(0);
                    $("#transfer_price").focus();
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    $.each(data, function(key, value) {
                        ...
                        $("#credit_price").val(formatNumber(parseFloat(value.credit_price)
                            .toFixed(2)));
                        ...
                        if (pay_type_id_fk == '') {
                            ...
                            $("#cash_pay").val(formatNumber(parseFloat(value.cash_pay).toFixed(
                                2)));
                        }
                        // $("#transfer_money_datetime").val(value.transfer_money_datetime);
                        $('.myloading').hide();
                        ...
                        if (value.gift_voucher_price == null) {
                            ...
                            if (pay_type_id_fk == 4) {
                                ...
                                if (pay_type_id_fk == 12) {
                                    ...
                                    if (pay_type_id_fk == 13) {
                                        $("#gift_voucher_price").val(value.gift_voucher_price);
                                        $('#credit_price').val(parseFloat(value.credit_price)
                                            .toFixed(2));
                                        $('#sum_credit_price').val(parseFloat(value
                                            .sum_credit_price).toFixed(2));
                                    } else
                                        // Gift Voucher + เงินสด
                                        if (pay_type_id_fk == 19) {
                                            $("#gift_voucher_price").val(parseFloat(value
                                                .gift_voucher_price).toFixed(2));
                                            $("#cash_pay").val(parseFloat(value.cash_pay)
                                                .toFixed(2));
                                        } else {
                        ...
                        */
                        ...
                        $.each(d, function(key, value) {
                            ...
                            if (value.shipping_free == 1) {
                                ...
                                $('#shipping_price').val(formatNumber(parseFloat(value.shipping_price)
                                    .toFixed(2)));
                                $('.input_shipping_free').hide();
                                $('.input_shipping_nofree').show();
                            }
        ...
        $(function() {
            ...
            oTableChooseCourse = $('#data-table-choose-course').DataTable({
                ...
                columns: [{
                        data: 'id',
                        title: 'ID',
                        className: 'text-center w30'
                    },
                    {
                        data: 'ce_name',
                        title: '<center>ชื่อกิจกรรม</center>',
                    ...
                    {
                        data: 'ce_place',
                        title: '<center>สถานที่จัดงาน</center>',
                        className: 'text-left w150 '
                    },
                    {
                        data: 'ce_ticket_price',
                        title: '<center>ราคาบัตร (บาท)</center>',
                        className: 'text-center'
                    },
                    {
                        data: 'ce_sdate',
                        title: '<center>เริ่ม</center>',
                        className: 'text-center  w70  '
                    },
                    {
                        data: 'ce_edate',
                        title: '<center>สิ้นสุด</center>',
                        className: 'text-center  w70 '
                    },
                    {
                        data: 'id',
                        title: '<center>จำนวนสมัคร</center>',
                        className: 'text-center  w70 '
                    },
                    {
                        data: 'id',
                        title: '',
                        className: 'text-center w2 '
                    },
                ],
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['CourseCheckRegis'] == "success") {
                        $("td:eq(7)", nRow).html(
                            '<center><input class="form-control amt_apply in-tx " type="number"  name="amt_apply[]" user_name="' +
                            aData['user_name'] + '" id_course="' + aData['id'] +
                            '" style="background-color:#e6ffff;border: 2px inset #EBE9ED;width:60%;text-align:center;" ><input type="hidden" name="id[]" value="' +
                            (aData['id']) + '" >');
                    } else {
                        ...
                        $("td:eq(7)", nRow).html(
                            '<center><input class="form-control " type="text" style="background-color:#d9d9d9 !important;border: 1px inset #EBE9ED;width:60%;text-align:center;cursor:pointer;" readonly placeholder="-" data-toggle="tooltip" title="สาเหตุที่ซื้อไม่ได้ เพราะ ' +
                            aData['cuase_cannot_buy'] + ' "  >');
                        for (var i = 0; i < 7; i++) {
            ...
            $(document).on('change', '.amt_apply', function(event) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data == "fail") {
                            alert(
                                "! ไม่สามารถสมัครคอร์สนี้ได้ เนื่องจากไม่เข้าเงื่อนไขเกณฑ์ที่กำหนด โปรดตรวจสอบอีกครั้ง"
                            );
                            $('.amt_apply').val('');
                            $('.amt_apply').focus();
                            $('.myloading').hide();
    ...
    <script>
        $(document).on('click', '.btnAddAiCashModal02', function(event) {
            ...
            // alert(customer_id);
            setTimeout(function() {
                location.replace("{{ url('backend/add_ai_cash/create') }}" + "/?customer_id=" +
                    customer_id + "&frontstore_id_fk=" + frontstore_id_fk + "&member_name_aicash=" +
                    member_name_aicash + "&fromAddAiCash=1");
            }, 1000);
        });
                ...
                if (result.value) {
                    ...
                    if (pay_type_id_fk == 6 || pay_type_id_fk == 9 || pay_type_id_fk == 11 ||
                        ...
                        if (aicash_price >= 0 && aicash_remain <= 0) {
                            alert(
                                "! ยอด Ai-Cash ไม่เพียงพอต่อการชำระช่องทางนี้ กรุณาเติมยอด Ai-Cash ขอบคุณค่ะ"
                            );
                            return false;
                        } else {
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            // $('#all_contacts').select2('data', {id: 'O122082800005', text: 'O122082800005'}).trigger('change');
            ...
            $(document).on('change', '#aistockist', function(event) {
                ...
                if (order_id != '') {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: " {{ url('backend/frontstore/edit_ai') }} ",
                        data: {
                            _token: '{{ csrf_token() }}',
                            order_id: order_id,
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#customers_id_fk_name', function(event) {
