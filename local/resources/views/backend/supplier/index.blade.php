            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right" >
                    <a class="btn btn-info btn-sm mt-1 class_btn_add " href="{{ route('backend.supplier.create') }}">
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        columns: [
            ...
            {data: 'txt_desc', title :'<center>ชื่อ Supplier </center>', className: 'text-center'},
            {data: 'tel', title :'<center>เบอร์โทร</center>', className: 'text-center'},
            {data: 'addr', title :'<center>ที่อยู่ </center>', className: 'text-center'},
        ...
        rowCallback: function(nRow, aData, dataIndex){
              ...
              var str_U = '';
              if(sU=='1'){
                str_U = '<a href="{{ route('backend.supplier.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" ><i class="bx bx-edit font-size-16 align-middle"></i></a> ';
              }
              var str_D = '';
              if(sD=='1'){
                ...
                // str_D = '<a href="javascript: void(0);" data-url="{{ route('backend.supplier.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete" ><i class="bx bx-trash font-size-16 align-middle"></i></a>';
              }
              if(sU!='1' && sD!='1'){
    ...
    function go_to_rem(id){
      if (confirm('Are you sure?')) {
          window.location.replace("{{ route('backend.supplier.index') }}/"+id)
      }
    }
});
</script>
