           ...
           {{--      <div class="col-lg-12">
            ...
            <!--     <div class="stars stars-example-css m-t-15 detail-stars col-lg-12">
              ...
              <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12 col-12 text-center">
               <a href="{{ route('product-list-6') }}" class="btn btn-warning" style="margin-top: -2px" type=""><i class="fa fa-cart-plus"></i> <span class="m-l-10">เลือกสินค้าเพิ่ม </span></a>
             </div>
...
<script type="text/javascript">
  function addcart(id) { 
    ...
    $.ajax({
      ...
      type: 'get',
            // dataType: 'json',
            data: {id:id,quantity:quantity,name:name,price:price,pv:pv,img:img,title:title,promotion:promotion,type:'6'},
          })
    .done(function(data) {
     $('#count_cart').html(data);
     var count_cart = '<i class="fa fa-shopping-cart"></i> '+data;
     $('#count_cart_6').html(count_cart);
          //console.log(data);
        })
    .fail(function() {
      console.log("error");
