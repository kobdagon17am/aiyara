...
@ENDIF
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-8">
                              <select name="product_out_cause_id_fk" class="form-control select2-templating " id='export' required onchange="g_export('export')" >
                        ...
                        @ENDIF
                                ...
                                @else
                                  ...
                                  @if(@$Check_stock)
                                    @foreach(@$Check_stock AS $r)
                                      <option value="{{$r->lot_number}}" {{ (@$r->id==@$sRow->stocks_id_fk)?'selected':'' }} >
                                        {{$r->lot_number}}
                                        [{{ $r->w_name }}]
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-3">
                              <input class="form-control" type="number" value="{{ @$sRow->amt }}" id="amt"  name="amt"  min="1" required >
                            </div>
                          </div>
