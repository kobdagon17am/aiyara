...
<div class="row">
    <div class="col-10">
        <div class="card">
            <div class="card-body">
              @if( empty(@$sRow) )
              <form action="{{ route('backend.products_return.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              @else
              <form action="{{ route('backend.products_return.update', @$sRow->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              @endif
                {{ csrf_field() }}
                      ...
                      <div class="myBorder">
                          ...
                          <div class="form-group row">
                            <label for="products_return_slip" class="col-md-2 col-form-label">ใบจัดส่ง :</label>
                            <div class="col-md-10">
                              <input class="form-control" type="text" value="{{ @$sRow->products_return_slip }}" name="products_return_slip" >
                            </div>
                          </div>
                          ...
                          <div class="form-group row">
                            <label for="products_return_tatus" class="col-md-2 col-form-label">สถานะการจัดส่ง :</label>
                            <div class="col-md-10">
                              <input class="form-control" type="text" value="{{ @$sRow->products_return_tatus }}" name="products_return_tatus" >
                            </div>
                          </div>


                          <div class="form-group row">
                            <label for="products_return_date" class="col-md-2 col-form-label">วันที่จัดส่ง : * </label>
                            <div class="col-md-3">
                              <input class="form-control" type="date" value="{{ @$sRow->products_return_date }}" name="products_return_date" required >
                            </div>
                          </div>
                ...
                <div class="form-group mb-0 row">
                  <div class="col-md-6">
                    <a class="btn btn-secondary btn-sm waves-effect" href="{{ url("backend/products_return") }}">
