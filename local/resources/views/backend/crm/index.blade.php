...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        columns: [
            ...
            // {data: 'contact_details', title :'<center>รายละเอียดติดต่อ </center>', className: 'text-left'},
            {data: 'subject_recipient', title :'<center>ผู้รับเรื่อง </center>', className: 'text-left'},
            {data: 'operator', title :'<center>ผู้ดำเนินการ </center>', className: 'text-left'},
        ...
        rowCallback: function(nRow, aData, dataIndex){
          $('td:last-child', nRow).html(''
            + '<a href="{{ route('backend.crm.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary"><i class="bx bx-edit font-size-16 align-middle"></i></a> '
            + '<a href="javascript: void(0);" data-url="{{ route('backend.crm.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete"><i class="bx bx-trash font-size-16 align-middle"></i></a>'
          ).addClass('input');
        }
    });
