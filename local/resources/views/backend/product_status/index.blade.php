            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right" style="{{@$sC}}" >
                    <a class="btn btn-info btn-sm mt-1" href="{{ route('backend.product_status.create') }}">
        ...
        rowCallback: function(nRow, aData, dataIndex){
          ...
          if(sU!=''){
              $('td:last-child', nRow).html('-');
                  ...
                  $('td:last-child', nRow).html(''
                  + '<a href="{{ route('backend.product_status.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" style="'+sU+'" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                  + ''
                ).addClass('input');
