...
<div class="row">
    <div class="col-10">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> ตรวจสอบรับเงินรายวัน AI cash</h4>
    ...
    <div class="col-10">
        ...
        @IF($sRow->status_cancel==0 && $sRow->status_approve==0)
          ...
          <div class="myBorder">
              ...
              <form action="{{ url('backend/check_money_daily_ai_store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
              ...
              @else
              <form action="{{ url('backend/check_money_daily_ai_update', @$sRowCheck_money_daily[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
     ...
     @if( !empty(@$sRowCheck_money_daily[0]->id) )
              ...
              <form id="frm" action="{{ url('backend/check_money_daily_ai_update', @$sRowCheck_money_daily[0]->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input name="_method" type="hidden" value="PUT">
                <input name="id" type="hidden" value="{{@$sRow->id}}">
                <input name="sRowCheck_money_daily_id" type="hidden" value="{{@$sRowCheck_money_daily[0]->id}}">
...
<div class="row">
    <div class="col-10">
        <div class="card">
          ...
          <div class="myBorder">
              ...
              <form id="frm" action="{{ url('backend/check_money_daily_ai_store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input name="add_ai_cash_id_fk" type="hidden" value="{{@$sRowAdd_ai_cash->id}}">
              @else
              <form id="frm" action="{{ url('backend/check_money_daily_ai_update', @$sRowAdd_ai_cash->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input name="_method" type="hidden" value="PUT">
                <input name="add_ai_cash_id_fk" type="hidden" value="{{@$sRowAdd_ai_cash->id}}">
 ...
 @if( !empty(@$sRowCheck_money_daily_AiCash[0]->id) )
              ...
              <form id="frm" action="{{ url('backend/check_money_daily_ai_update', @$sRowCheck_money_daily_AiCash[0]->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input name="_method" type="hidden" value="PUT">
                <input name="add_ai_cash_id_fk" type="hidden" value="{{@$sRowAdd_ai_cash->id}}">
