...
<head>
    @include('layouts/promote/inc_header')
...
<style>
    ...
    .promotions {
        ...
        padding-bottom: 5px;
        font-weight: normal;
        background: url(../webpromote/images/title-h-line.png) no-repeat left bottom;
    }
...
<body style="background-color: #f7f7f7;">
   @include('layouts/promote/inc_topmenu')


   @yield('conten')


  @include('layouts/promote/inc_footer')
