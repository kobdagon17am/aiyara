            ...
            <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 text-right" >
                    <a class="btn btn-info btn-sm mt-1 class_btn_add " href="{{ route('backend.product_out_cause.create') }}">
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.product_out_cause.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        rowCallback: function(nRow, aData, dataIndex){
              ...
              var str_U = '';
              if(sU=='1'){
                str_U = '<a href="{{ route('backend.product_out_cause.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" ><i class="bx bx-edit font-size-16 align-middle"></i></a> ';
              }
