<link rel="stylesheet" href="{{asset('public/webpromote/secondary-expandable-navigation-master/css/style.css')}}">
<!-- Resource style -->
<script src="{{asset('public/webpromote/secondary-expandable-navigation-master/js/modernizr.js')}}"></script>
<!-- Modernizr -->
<style>
    .bg-dark {
...
<script src="{{asset('public/webpromote/secondary-expandable-navigation-master/js/main.js')}}"></script>
<!-- Resource jQuery -->
<script>
