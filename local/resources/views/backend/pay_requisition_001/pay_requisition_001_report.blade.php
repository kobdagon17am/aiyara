        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.approve_btn', function() {
                ...
                if (data_type == 'approve') {
                    url = "{{ url('backend/pay_requisition_001_report/consignments_approve/1') }}" + "/" +
                        data_id;
                }
                if (data_type == 'no_approve') {
                    url = "{{ url('backend/pay_requisition_001_report/consignments_approve/2') }}" + "/" +
                        data_id;
                }
            ...
            $(document).on('click', '.approve_btn_select', function() {
                var data_id = $(this).attr('data_id');
                var url = "{{ url('backend/pay_requisition_001_report/consignments_approve_select') }}";
                var arr_id = '';
                $(".arr_success").each(function(index) {
                ...
                oTable = $('#data-table-packing').DataTable({
                    ...
                    columns: [{
...

                        {
                            ...
                            title: '<span style="vertical-align: middle;"><center> สถานะการจัดส่ง  xxxxxxx</span>xxxxxxx ',
                            className: 'text-center w100 ',
                            render: function(d) {
                                return d;
                            }
                        ...
                        {
                            data: 'tracking_remark',
                            title: '<span style="vertical-align: middle;"><center> หมายเหตุ  </span> ',
                            className: 'text-center w200 ',
                            render: function(d) {
                                return d;
                            }
                        },
                        ...
                        {
                            data: 'tracking_approve',
                            title: '<span style="vertical-align: middle;"><center> ยืนยันสถานะ  </span> ',
                            className: 'text-center w100 ',
                            render: function(d) {
                                return d;
                            }
                ...
                $(function() {
                    ...
                    oTable = $('#data-table-packing').DataTable({
                        ...
                        columns: [{
                            ...
                            {
                                data: 'tracking_status',
                                title: '<span style="vertical-align: middle;"><center> สถานะการจัดส่ง  </span> <br>' +
                                    "<a class='btn btn-success btn-sm approve_btn_select' style='color:white;' href='javascript:;'>จัดส่งสำเร็จตามที่เลือก</a>",
                                className: 'text-center w100 ',
                                render: function(d) {
                                    return d;
                                }
