 ...
 @section('css')
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-1to10.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-horizontal.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-movie.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-pill.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-reversed.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/bars-square.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/jquery-bar-rating/css/css-stars.css') }}">
     <!-- slick css -->
     <link rel="stylesheet" type="text/css" href="{{ asset('frontend/bower_components/slick-carousel/css/slick.css') }}">
     <link rel="stylesheet" type="text/css"
         href="{{ asset('frontend/bower_components/slick-carousel/css/slick-theme.css') }}">
                                             ...
                                             <div class="port_big_img">
                                                 @if ($data['type'] == '6')
                                                     <img class="img img-fluid"
                                                         src="{{ asset($value_img->img_url . '/' . $value_img->img_name) }}"
                                                         alt="">
                                                 @else
                                                     <img class="img img-fluid"
                                                         src="{{ asset($value_img->img_url . '/' . $value_img->product_img) }}"
                                                         alt="">
                                                 @endif
                                             </div>
                                         @endforeach
                      ...
                      <span class="f-right">Availability : <a href="#!"> In Stock </a> </span>
                                     ...
                                     <div class="col-lg-12">
                                         @if ($data['type'] == '6')
                                             ...
                                             ?>
                                             <h4 class="pro-desc">{{ $data['product_data']->ce_name }} <span
                                                     class="label label-success" style="font-size: 15px"><i
                                                         class="fa fa-users"></i>
                                                     {{ $count_ce }}/{{ $data['product_data']->ce_max_ticket }}
                                                 </span></h4>
                                         @else
                        ...
                        <option value="5">5</option>
                                     ...
                                     @if ($data['type'] == 6)
                                         <div class="col-lg-12">
                                             ...
                                             <h4> {{ number_format($data['product_data']->ce_ticket_price, 2) }} <b
                                                     style="color:#00c454"> [{{ $data['product_data']->pv }} PV] </b></h4>
                                             <hr>
                                     ...
                                     @else
                                         <div class="col-lg-12">
                                             <h4>{!! @$data['product_data']->icon !!}
                                                 {{ number_format($data['product_data']->member_price, 2) }} <b
                                                     style="color:#00c454">@if ($data['type'] == 5)[0 PV]@else[{{ $data['product_data']->pv }} PV]@endif</b></h4>
                                             <hr>
                                             {!! $data['product_data']->descriptions !!}
                                             <hr>
                                         </div>
                                     ...
                                     <div class="row col-lg-12">
                                             ...
                                             <div class="p-l-0 m-b-25">
                                                 <div class="input-group">
                                                     ...
                                                     <input type="text" id="quant" name="quant[1]"
                                                         class="form-control input-number text-center" value="1" max="{{ $max }}">
                                                     <span class="input-group-btn">
                                                         <button type="button"
                                         ...
                                         @if ($data['type'] == 6)
                                             <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                                                 ...
                                                 @if ($ce_check['status'] == 'success')
                                                     <button type="button"
                                                         ...
                                                         data-type="success" data-from="top" data-align="right"
                                                         style="margin-top: -2px">
                                                         <i class="icofont icofont-cart-alt f-16"></i><span
                                                             class="m-l-10">ADD TO CART</span>
                                                     </button>
                                                 @else
                                                     <button type="button"
                                                         class="btn btn-inverse waves-effect waves-light btn-block"
                                                         data-type="success" data-toggle="tooltip" data-placement="bottom"
                                                         title="" data-original-title="{{ $ce_check['message'] }}"
                                                         data-from="top" data-align="right" style="margin-top: -2px">
                                                         <i class="icofont icofont-cart-alt f-16"></i><span
                                                             class="m-l-10">ADD TO CART</span>
                                                     </button>
                                                 @endif
                                             ...
                                             <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 col-12 text-center">
                                                 <a href="{{ route('product-list', ['type' => $data['type']]) }}"
                                                     class="btn btn-warning btn-block" style="margin-top: -2px" type=""><i
                                                         class="fa fa-cart-plus"></i> <span class="m-l-10">เลือกสินค้าเพิ่ม
                                                     </span></a>
                                             </div>
                                         @else
                                             <div class="col-lg-4 col-md-4 col-sm-6 col-xs-6 col-6">
                                                 ...
                                                 <button type="button"
                                                     onclick="addcart({{ $data['product_data']->products_id }})"
                                                     class="btn btn-primary waves-effect waves-light btn-block"
                                                     data-type="success" data-from="top" data-align="right"
                                                     style="margin-top: -2px">
                                                     <i class="icofont icofont-cart-alt f-16"></i><span class="m-l-10">ADD
                                                         TO CART</span>
                                                 </button>
                 ...
                 .done(function(data) {
                  console.log(data);
                     if (data['status'] == 'success') {
                         $('#count_cart').html(data['getTotalQuantity']);
                         $('#m_count_cart').html(data['getTotalQuantity']);
                         var count_cart = '<i class="fa fa-shopping-cart"></i> ' + data['getTotalQuantity'];
