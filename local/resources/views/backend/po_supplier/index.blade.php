...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> ใบ PO สั่งซื้อสินค้า </h4>
        </div>
    </div>
</div>
<!-- end page title -->
            ...
            <div class="row" style="margin-bottom: 2% !important;"  >
                ...
                <div class="col-md-6 " style="margin-top: -0.5% !important;" >
                  <div class="form-group row">
                    ...
                    <a class="btn btn-info btn-sm float-right " style="{{@$sC}}" href="{{ route('backend.po_supplier.create') }}">
                      <i class="bx bx-plus font-size-20 align-middle"></i>ADD สร้างใบ PO
                    </a>
...
$(function() {
    ...
    "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
        ...
        iDisplayLength: 25,
        ajax: {
          url: '{{ route('backend.po_supplier.datatable') }}',
          data: function ( d ) {
            d.Where={};
        ...
        rowCallback: function(nRow, aData, dataIndex){
          if(sU!=''&&sD!=''){
              ...
              $('td:last-child', nRow).html(''
                + '<a href="{{ route('backend.po_supplier.index') }}/'+aData['id']+'/edit" class="btn btn-sm btn-primary" style="'+sU+'" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
                + '<a href="javascript: void(0);" data-url="{{ route('backend.po_supplier.index') }}/'+aData['id']+'" class="btn btn-sm btn-danger cDelete" style="'+sD+'" ><i class="bx bx-trash font-size-16 align-middle"></i></a>'
              ).addClass('input');
