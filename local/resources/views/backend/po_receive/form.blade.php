                    ...
                    @endif
                      ...
                      <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <select name="supplier_id_fk" class="form-control select2-templating " disabled >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="row" >
                     <div class="col-md-6 " >
                      <div class="form-group row">
                        <label for="" class="col-md-3 col-form-label"> ชื่อสินค้า : </label>
                        <div class="col-md-8">
                    ...
                    <input type="hidden" name="product_id_fk"  id="product_id_fk" >
                ...
                <div class="row" >
                      ...
                      <div class="col-md-6 " >
                      <div class="form-group row">
                        <label for="amt_get" class="col-md-3 col-form-label"> จำนวนที่ได้รับ : </label>
                        <div class="col-md-4">
                    ...
                    <div class="col-md-6 " >
                      <div class="form-group row">
                         <label for="" class="col-md-3 col-form-label">หน่วย : * </label>
                        <div class="col-md-5">
       ...
       <div class="row" >
                    <div class="col-md-6 " >
                      <div class="form-group row">
                        <label for="" class="col-md-3 col-form-label"> Lot Number  : </label>
                        <div class="col-md-7">
                  <input type="text" class="form-control lot_number_auto " id="lot_number_auto" name="lot_number" required value="{{@$sRow->lot_number}}" >
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6 " >
                ...
                <div class="row" >
                    <div class="col-md-6 " >
                      <div class="form-group row">
                        ...
                        <div class="col-md-8">
                            <select id="branch_id_fk_c" name="branch_id_fk_c" class="form-control select2-templating " required >
                             <option value="">Select</option>
                             @if(@$sBranchs)
                              @foreach(@$sBranchs AS $r)
                              <option value="{{$r->id}}"  >
...
@section('script')
 ...
 <script>
  ...
  <script>
            ...
            $(function() {
                oTable = $('#data-table-history').DataTable({
                "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                    processing: true,
                    serverSide: true,
                    scroller: true,
