 ...
 @section('conten')
                                       ...
                                       @if($bill['type'] != 4)
                                                 ...
                                                 <div class="form-group row">
                                                     <div class="col-md-12">
                                                         <div class="input-group input-group-button">
                                                             <input type="text" id="username_aistockist" class="form-control"
                                                                 placeholder="รหัสสมาชิก">
                                                             <span class="input-group-addon btn btn-primary"
                                                                 onclick="check_aistockist()">
                                                                 <span class="">ตรวจสอบ</span>
                                                             </span>
                                                         </div>
                                         ...
                                         <div class="card bg-c-yellow order-card m-b-0">
                                             <div class="card-block" style="padding: 10px;">
                                                 <div class="row">
                                                  <div class="col-md-12">
                                                    <h6 class="m-b-0" style="color: #000">
                                                     ซื้อผ่าน AiStockist</h6>
                                                </div>

                                                     <div class="col-md-12 mt-2">
                                                         <h5 id="ai_text_username"
                                                             style="color: #000;font-size: 16px"></h5>
                                                         <h6 class="m-b-0" id="ai_tex_name"
                                                             style="color: #000"></h6>
                                                         <input type="hidden" name="aistockist_id_fk"
                                                             id="aistockist_id_fk" value="">

                                                         <input type="hidden" name="aistockist_username"
                                                             id="aistockist_username" value="">
                                                ...
                                                <hr class="m-b-5 m-t-5">
                                                     <div class="col-md-12">
                                                         ...
                                                         <h6 class="m-b-0" style="color: #000">
                                                             <b id="ai_tex_qualification_name"></b>
                                                         </h6>
                                     ...
                                     <div class="row" id="check_user" style="display: none">
                                         <div class="col-md-12">
                                             <div class="row">
                                                 ...
                                                 <div class="col-md-6 col-lg-6 col-xl-6" id="data_direct"
                                                     style="display: none">
                                                     <div class="card bg-c-yellow order-card m-b-0">
                                                         <div class="card-block" style="padding: 10px;">
                                                             <div class="row">
                                                             ...
                                                             <div class="row">
                                                                 <div class="col-md-6">
                                                                     <h5 class="m-b-0" style="color: #000">
                                                                         คะแนนสะสม</h5>
                                                                 </div>
                                                                 <div class="col-md-6">
                                         ...
                                         <div id="sent_address_card" style="display: none;" class="h_address">
                                             ...
                                             <div class="row m-t-5">
                                                 <div class="col-md-6 col-sm-6 col-6">
                                                     <label>Email</label>
                                                     <input type="email" class="form-control form-control-bold"
                                                         placeholder="Email" name="card_email"
                                             ...
                                             <div class="row m-t-5">
                                                 ...
                                                 <div class="col-md-3 col-sm-12 col-12">
                                                     <label>หมู่ที่ <b class="text-danger">*</b></label>
                                                     <input type="text" class="form-control form-control-bold"
                                                         placeholder="หมู่ที่" name="card_moo"
                                             ...
                                             <div class="row m-t-5">
                                                 <div class="col-sm-4">
                                                     <label>ถนน</label>
                                                     <input type="text" class="form-control form-control-bold"
                                                         placeholder="ถนน" name="card_road"
                                         ...
                                         <div id="sent_address_card" style="display: none;" class="h_address">
                                             ...
                                             <div class="alert alert-warning icons-alert">
                                                 <p><strong>Warning!</strong> <code>ไม่มีข้อมูลที่อยู่ตามบัตรประชาชน
                                                         กรุณาใช้ที่อยู่การจัดส่งรูปแบบอื่น </code> </p>
                                             </div>
                                         </div>
                                     @endif
                                        ...
                                        <div class="col-sm-3">
                                         ...
                                         <div class="row m-t-5">
                                             <div class="col-sm-4">
                                                 <label>ถนน</label>
                                                 <input type="text" class="form-control form-control-bold"
                                                     placeholder="ถนน" name="other_road">
                                             </div>
                     ...
                     <div class="table-responsive p-3">
                         <table class="table">
                             ...
                             @if ($bill['type'] == 5)
                                 ...
                                 <tr>
                                     <td><strong class="text-primary" style="font-size: 13px"> Ai Voucher
                                             คงเหลือ</strong></td>
                                         ...
                                         <table class="table">
                                             ...
                                             @else
                                                 ...
                                                 <tr>
                                                     ...
                                                     <td align="right"><strong> {{ number_format($gv_total) }}
                                                             GV</strong></td>
                                                 </tr>
                                             @endif
                                         </table>
                     ...
                     <div class="col-md-12 col-xl-12">
                         <div class="card bg-c-yellow order-card m-b-0">
                             <div class="card-block">
                                 ...
                                 <div class="row">
                                     <div class="col-md-6">
                                         <p class="m-b-0" style="color: #000"><b>สถานะรักษาคุณสมบัติรายเดือน</b>
                                         </p>
                                     </div>
                                     <div class="col-md-6 text-right">
                                 ...
                                 <div class="row">
                                     <div class="col-md-6">
                                         <p class="m-b-0" style="color: #000"><b>สถานะรักษาคุณสมบัติท่องเที่ยว</b>
                                         </p>
                                     </div>
                                     <div class="col-md-6 text-right">
     ...
     <div class="modal fade" id="large-Modal_ai" tabindex="-1" role="dialog">
      <div class="modal-dialog modal-md" role="document">
          ...
          <div class="modal-content">
                  ...
                  <div class="col-md-12 col-xl-12">
                      <div class="card bg-c-yellow order-card m-b-0">
                          <div class="card-block">
                              <div class="row">
                                  <div class="col-md-12">
                                      <h5 id="modal_text_username_aistockist" style="color: #000"></h5>
                                      <h6 class="m-b-0" id="ai_modal_name" style="color: #000"></h6>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6">
                                      <h5 class="m-b-0 text-right" id="ai_modal_text_pv" style="color: #000"></h5>
                                  </div>
                              </div>
                              <hr class="m-b-5 m-t-5">
                              <div class="row">
                                  ...
                                  <div class="col-md-6 text-right">
                                      <div id="ai_modal_pv_mt_active"></div>
                                  </div>
                              </div>
                              ...
                              <div class="row">
                                  ...
                                  <div class="col-md-6 text-right">
                                      <div id="ai_modal_pv_tv_active"></div>
                                  </div>
                              </div>
              ...
              <div class="modal-footer">
                  <button type="button" class="btn btn-default waves-effect " data-dismiss="modal">Close</button>
                  <div id="ai_confirm_pay_sent_customer"></div>
 ...
 @section('js')
    ...
    <script src="{{ asset('frontend/custom/cart_payment/sent_type.js') }}"></script>{{-- ส่งให้ตัวเอง หรือส่งให้คนอื่น --}}
     ...
     <script type="text/javascript">
         ...
         function sent_address(type_sent,provinces_id) {
             ...
             if (type_sent == 'sent_address') {
                 ...
                 document.getElementById("btn_pay").style.display = 'block';
                 document.getElementById('shipping_detail').innerHTML =
                     '<label class="label label-inverse-warning">รับที่สาขา</label>';
     ...
     <script type="text/javascript">
         ...
         function check_aistockist() {
             //var url = '{{ route('cart_delete') }}';
             var username = $('#username_aistockist').val();
             $.ajax({
                     url: '{{ route('check_customer_aistockis') }}',
                     type: 'POST',
                     data: {
                         _token: '{{ csrf_token() }}',
                         'user_name': username
                 ...
                 .done(function(data) {
                     console.log(data['data']);
                     if (data['status'] == 'success') {
                         document.getElementById("modal_text_username_aistockist").innerHTML = data['data']['data'][
                                 'business_name'
                             ] +
                             ' (' + data['data']['data']['user_name'] + ')';

                         document.getElementById("ai_modal_name").innerHTML = data['data']['data']['first_name'] + ' ' + data['data']['data']['last_name'];

                         document.getElementById("ai_modal_text_pv").innerHTML = data['data']['data']['pv'] + ' PV';
                         $("#input_username").val(data['data']['data']['user_name']);

                         document.getElementById("ai_modal_pv_tv_active").innerHTML = data['pv_tv_active'];
                         document.getElementById("ai_modal_pv_mt_active").innerHTML = data['pv_mt_active'];

                         document.getElementById("ai_qualification_name").innerHTML = data['data']['data'][
                             'qualification_name'
                         ];

                         var ai_customer_username = data['data']['data']['user_name'];
                         document.getElementById("ai_confirm_pay_sent_customer").innerHTML =
                             '<button  class="btn btn-success" onclick="ai_confirm(\'' +
                             ai_customer_username + '\')">Confirm</button>';

                         $("#large-Modal_ai").modal();
                         //alert(data['status']);
