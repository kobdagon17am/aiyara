              ...
              @endif
                {{ csrf_field() }}
                      ...
                      <div class="myBorder">
                        ...
                        <input name="shipping_cost_id" type="hidden" value="{{ @$sRowNew->id}}">

                        <div class="form-group row">
                            <label for="" class="col-md-2 col-form-label"> จังหวัด : * </label>
                            <div class="col-md-10">
                ...
                <div class="form-group mb-0 row">
                    <div class="col-md-6">
                        <a class="btn btn-secondary btn-sm waves-effect" href="{{ route('backend.shipping_cost.index') }}/{{@$sRowNew->id}}/edit" }}">
