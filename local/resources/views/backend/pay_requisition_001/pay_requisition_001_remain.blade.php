...
<script>
              ...
              "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                  ...
                  rowCallback: function(nRow, aData, dataIndex){
                          ...
                          if(aData['status']==1){
                              ...
                              // วุฒิเพิ่ม
                              + '<a href="{{ url('backend/pick_warehouse/print_requisition_detail_real_remain/') }}/'+aData['id']+'" target="blank" class="btn btn-sm btn-success"  data-toggle="tooltip" data-placement="left" title="รายละเอียดลูกค้าทั้งหมด" ><i class="bx bx-printer grow " style="font-size:14px;cursor:pointer;color:white;margin-top:1px;"></i></a> '
                              + '<a href="{{ url('backend/frontstore/print_receipt_lading_display/') }}/'+aData['id']+'" target="blank" class="btn btn-sm btn-primary"  data-toggle="tooltip" data-placement="left" title="พิมพ์ใบเสร็จทั้งหมด" ><i class="bx bx-printer grow " style="font-size:14px;cursor:pointer;color:white;margin-top:1px;"></i></a> '
 ...
 // วุฒิเพิ่ม
     + '<a href="{{ url('backend/pick_warehouse/print_requisition_detail_real_remain/') }}/'+aData['id']+'" target="blank" class="btn btn-sm btn-success"  data-toggle="tooltip" data-placement="left" title="รายละเอียดลูกค้าทั้งหมด" ><i class="bx bx-printer grow " style="font-size:14px;cursor:pointer;color:white;margin-top:1px;"></i></a> '
 + '<a href="{{ url('backend/frontstore/print_receipt_lading_display/') }}/'+aData['id']+'" target="blank" class="btn btn-sm btn-primary"  data-toggle="tooltip" data-placement="left" title="พิมพ์ใบเสร็จทั้งหมด" ><i class="bx bx-printer grow " style="font-size:14px;cursor:pointer;color:white;margin-top:1px;"></i></a> '
                                 + '<a href="{{ url('backend/pick_warehouse') }}/'+aData['id']+'/cancel?remain=1" class="btn btn-sm btn-primary" data-toggle="tooltip" data-placement="left" title="ดูข้อมูลการจ่ายแต่ละครั้ง" ><i class="bx bx-edit font-size-16 align-middle"></i></a> '
