...
class Pay_product_packingController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      return View('backend.pay_product_packing.index')->with(
        array(
           'sDelivery'=>$sDelivery,
           'Customer'=>$Customer,
 ...
 public function create()
    ...
    public function store(Request $request)
    {
      ...
      if(isset($request->save_to_set)){
        ...
        return redirect()->to(url("backend/pay_product_packing/scan_qr/".$request->invoice_code));
    ...
    {
       // $sRow = \App\Models\Backend\Pay_product_packing::find($id);
   ...
   public function form($id=NULL)
    {
      ...
      try {
        ...
        echo $e->getMessage();
        \DB::rollback();
        return redirect()->action('backend\Pay_product_packingController@index')->with(['alert'=>\App\Models\Alert::e($e)]);
      }
    }
    ...
    public function Datatable(){
      // $sTable = \App\Models\Backend\Pay_product_packing::search()->where('status_pick_warehouse','0')->orderBy('id', 'asc');
      $sTable = DB::select(" 
