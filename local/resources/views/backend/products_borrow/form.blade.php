...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
            <h4 class="mb-0 font-size-18"> ข้อมูลรายละเอียดการเบิก/ยืม</h4>
        </div>
    </div>
</div>
<!-- end page title -->
    ...
    <div class="col-10">
        <div class="card">
            ...
            <div class="myBorder">
              ...
              @else
              <form action="{{ route('backend.products_borrow.update', @$sRow->id ) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
