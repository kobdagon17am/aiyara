        ...
        ajax: {
          ...
          method: 'POST'
              ...
              columns: [
                  ...
                  {data: 'total_price', title :'', className: 'text-center'}, 
              ],
              'columnDefs': [
               {
                  'targets': [0,12],
            ...
            $('#data-table').on( 'click', 'tr', function () {
                 ...
                 $(".myloading").show();
                  ...
                  setTimeout(function(){
                    ...
                    // let sum = parseFloat($("#total_price").val());

                          var rows_selected = $('#data-table').DataTable().column(12).checkboxes.selected();
                          $.each(rows_selected, function(index, rowId){
                            ...
                            $('#last_form').after(
                             ...
                             //     type:'POST',
                             //     dataType:'JSON',
                             //     url: " {{ url('backend/ajaxGetTotalPriceDelivery') }} ",
                             ...
                             //      success:function(data){
                                         ...
                                         //            .attr('type', 'text')
                                         //            .attr('name', 'sum[]')
                                         //            .val(value.total_price)
                                         //     );
                                         //  });

                                         // shipping_price = parseFloat($("#shipping_price").val());
                                         // sum = parseFloat($("#total_price").val());
                                         
                                         // $.each(data,function(key,value){shipping_price+=parseFloat(value.shipping_price) || 0;});
                                         // $.each(data,function(key,value){sum+=parseFloat(value.total_price) || 0;});
                                         // console.log(sum);
                          ...
                          // var total_price = $('#data-table').DataTable().column(12).checkboxes.selected();
                          // $.each(total_price, function(index, rowData){
