      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="text-center">
            <h1 class="h4 text-gray-900">ประเภทสินค้า</h1>
          </div>
        </div>
          ...
          <form class="user">
            <div class="form-group row" >
              <div class="col-lg-2 col-sm-12">
                <input id='img1' type="button" value="+ เพิ่ม ประเภทสินค้า"  style="  background-color: #00c454; color: white;" class="btn btn-user btn-block" />
              </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row" >
              <div class="col-lg-12 col-sm-12">
                <table class="table table-striped table-responsive " >
                  ...
                  <tr>
                    <td>{{ $x }}</td>
                    <td>ประเภทสินค้าที่ {{ $x }}</td>
                    <td>รายละเอียดประเภทสินค้าที่ {{ $x }}</td>
                  ...
                  <tr>
                    <td>{{ $x }}</td>
                    <td><span id='cat_1'>ประเภทสินค้าที่ {{ $x }}</span></td>
                    <td>รายละเอียดประเภทสินค้าที่ {{ $x }}</td>
                  ...
                  <div class='modal-dialog modals-sm'>
                    <div class='modal-content'>
                      ...
                      <div class='modal-body' style=' text-align: left;'>
                        <input type="text" class="form-control form-control-user" id="ticketno1" placeholder="ใส่ประเภทสินค้า">
                        <br/>
                        <input type="text" class="form-control form-control-user" id="ticketno1" placeholder="รายละเอียดประเภทสินค้า">
                        <br/>
