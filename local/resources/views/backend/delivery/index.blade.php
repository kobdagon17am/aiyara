            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="myBorder">
                        ...
                        <div class="row">
                            <div class="col-md-6 ">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select id="receipt" name="receipt" class="form-control select2-templating "
                                            required>
                        ...
                        <form action="{{ route('backend.delivery.store') }}" method="POST"
                    ...
                    <table id="data-table-packing2" class="table table-bordered " style="width: 100%;"></table> --}}
                    ...
                    <form action="{{ route('backend.delivery.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="col-12">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <select id="delivery_province" name="delivery_province" required
                                        class="form-control select2-templating ">
                                        <option value="">Select</option>
                                        @if (@$sProvince)
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <select id="delivery_amphur" name="delivery_amphur" required
                                        class="form-control select2-templating " required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-7">
                                    <select id="delivery_tambon" name="delivery_tambon" required
                                        class="form-control select2-templating " required>
        ...
        $(function() {
            ...
            oTable = $('#data-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'delivery_date',
                        title: '<center>วันเวลาที่ออกบิล </center>',
                    ...
                    {
                        data: 'billing_employee',
                        title: '<center>พนักงานที่ออกบิล </center>',
                        className: 'text-center'
                    },
                    {
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    if (aData['shipping_price'] >
                        0) { // 1=orders จาก frontend,2=db_orders จากการขายหลังบ้าน
                        $('td:eq(2)', nRow).html(
        ...
        $(function() {
            ...
            oTable2 = $('#data-table-packing').DataTable({
                ...
                rowCallback: function(nRow, aData, dataIndex) {
                    ...
                    var str_U = '';
                    if (sU == '1') {
                        str_U = '<a href="{{ route('backend.account_bank.index') }}/' + aData['id'] +
                            '/edit" class="btn btn-sm btn-primary"  ><i class="bx bx-edit font-size-16 align-middle"></i></a> ';
                    }
                    var str_D = '';
                    if (sD == '1') {
                        str_D = '<button class="btn btn-sm btn-danger" onclick="go_to_rem(' + aData[
                                'id'] +
                    ...
                    if (sU != '1' && sD != '1') {
                        ...
                        if (aData['status_delivery'] != "1") {
                            $('td:last-child', nRow).html(''
                                ...
                                +
                                '<a href="javascript: void(0);" data-url="{{ route('backend.delivery_packing_code.index') }}/' +
                                aData['id'] + '" class="btn btn-sm btn-danger cCancel " data-id="' +
                                aData['id'] +
        ...
        function get_data2() {
            ...
            oTable = $('#data-table-packing2').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'status_delivery',
                        title: '<center>สถานะการเบิก </center>',
                        className: 'text-center ',
                        render: function(d) {
                            return '-รอจัดเบิก-';
                        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            ...
                            if (value.province_id_fk != '' && typeof value.province_id_fk !==
                                "undefined") {
                                $.ajax({
