        ...
        <div class="card">
            <div class="card-body">
                <div class="row">
                      ...
                      <div class="col-md-2 ">
                        <div class="form-group row">
                          <select id="seller" name="seller" class="form-control select2-templating " >
                            <option value="">พนักงานที่รับ</option>
                             @if(@$sSeller)
                  ...
                  <div class="myBorder">
                    <span style="font-weight: bold;"> <i class="bx bx-play"></i> สรุปยอดรับ </span>
        ...
        $(function() {
            oTable0002 = $('#data-table-0002').DataTable({
             "sDom": "<'row'<'col-sm-12'tr>><'row'<'col-sm-5'i><'col-sm-7'p>>",
                ...
                destroy:true,
                      ajax: {
                          url: '{{ route('backend.check_money_daily02.datatable_report') }}',
                          type: "POST",
                           data:{ _token: '{{csrf_token()}}', business_location:1},
                      },
                columns: [
                    {data: 'created_at', title :'<span style="vertical-align: middle;"> วันที่รับเงิน </span> ', className: 'text-center'},
                    ...
                    {data: 'approve_user', title :'<span style="vertical-align: middle;"> ผู้รับ </span> ', className: 'text-center'},
                    {data: 'total_money', title :'<span style="vertical-align: middle;"> ยอดรับ </span> ', className: 'text-right'},
                ...
                rowCallback: function(nRow, aData, dataIndex){
                  ...
                  if(aData['remark']==2){
                    ...
                    if(aData['total_money']){
                      $('td:eq(2)', nRow).html('<span class="text-right" style="color:black;font-size:16px;font-weight:bold;"> รวมทั้งสิ้น </span>');
                      $('td:eq(3)', nRow).html('<span class="text-right" style="color:black;font-size:16px;font-weight:bold;">'+aData['total_money']+'</span>');
                    }
                  }
