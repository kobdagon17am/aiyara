                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-10">
                                                    ...
                                                    <input type="file" name="file_slip" id="file_slip"
                        ...
                        <form action="{{ route('re_new_payment') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="channel_list" id="promptpay_channel_list"
                                        value="promptpay">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default waves-effect "
                                        data-dismiss="modal">Close</button>
                                    <button class="btn btn-success md-auto" name="submit" value="PromptPay"
                        ...
                        <form action="{{ route('re_new_payment') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="channel_list" id="truemoney_channel_list"
                                        value="truemoney">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-default waves-effect "
                                        data-dismiss="modal">Close</button>
                                    <button class="btn btn-success md-auto" name="submit" value="TrueMoney"
                                        type="submit">Confirm</button>
                                </div>
            ...
            <div class="card">
                ...
                <div class="card-block">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <input type="hidden" name="delete_aicash_id" id="delete_aicash_id"
                                                    value="">
                                            </div>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <input type="hidden" name="confirm_aicash_order_id"
                                                    id="confirm_aicash_order_id" value="">
                                            </div>
                    ...
                    <div class="modal fade" id="cancel_aicash" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-md" role="document">
                            <form action="{{ route('cancel_aicash') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="cancel_title_aicash">ยืนยันการยกเลิกรายการ Ai-Cash
                                        </h5>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <button class="btn btn-primary" type="submit"
                                                    name="submit">Confirm</button>
                                                <input type="hidden" name="cancel_aicash_id" id="cancel_aicash_id"
                                                    value="">
                                            </div>
                    ...
                    <div class="modal fade" id="cancel_aicash_backend" tabindex="-1" role="dialog">
                        <div class="modal-dialog modal-md" role="document">
                            <form action="{{ route('cancel_aicash_backend') }}" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="cancel_title_aicashbackend">ยืนยันการยกเลิกรายการ
                                            Ai-Cash</h5>
                                    </div>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group row">
                                            <div class="col-sm-12 text-center">
                                                ...
                                                <button class="btn btn-primary" type="submit"
                                                    name="submit">Confirm</button>
                                                <input type="hidden" name="cancel_aicash_backend_order_id"
                                                    id="cancel_aicash_backend_order_id" value="">
                                            </div>
                                    ...
                                    <div class="card bg-c-green order-card">
                                        <div class="card-block">
                                            ...
                                            <h2 class="text-right"><i class="ti-wallet f-left"></i><span
                                                    id="price_add_aicash"></span></h2>


                                            <p id="status"></p>
                                            {{-- <p class="m-b-0">Stattus<span class="f-right" id="status">Success</span></p> --}}
                                            <p class="m-b-0" style="margin-top: 31px;">Action Date <span class="f-right"
                                                    id="date_aicash">
                                                </span></p>
                                        </div>
                                    </div>
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    if (type_qr_modal == 'non') {
                        countdown.innerHTML =
                            '00:00 <button class="btn btn-sm btn btn-success btn-outline-success btn-icon" onclick="refresh_time(' +
                            id + ',\'refresh_time\')"> <i class="icofont icofont-refresh"></i> </button>';
                    } else {
                        ...
                        timerId = setInterval(function() {
                            ...
                            countdown.innerHTML = minutes + ' : ' + seconds +
                                ' <button class="btn btn-sm btn btn-success btn-outline-success btn-icon" onclick="refresh_time(' +
                                id + ',\'refresh_time\',' + timerId +
                                ')"> <i class="icofont icofont-refresh"></i> </button>';
                    ...
                    var close_modal_html =
                        '<button type="button" class="btn btn-default waves-effect" onclick="time_stop(' + timerId +
                        ')" >Close</button>';
                ...
                .done(function(data) {
                  ...
                  <div class="row">
                      ...
                      <div class="col-md-8">
                          ...
                          <p class="m-b-0 text-right" id="text_pv" style="color: #000">` + data['customer'][
                        'first_name'
                    ] + ` ` + data['customer']['last_name'] + `(` + data['customer']['business_name'] + `)</p>
                      </div>
